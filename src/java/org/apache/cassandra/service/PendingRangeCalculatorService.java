...
public class PendingRangeCalculatorService {
    ...
    public static transient org.slf4j.Logger logger_IC = org.slf4j.LoggerFactory.getLogger(PendingRangeCalculatorService.class);

    public static final transient PendingRangeCalculatorService instance = new PendingRangeCalculatorService();

    private static transient Logger logger = LoggerFactory.getLogger(PendingRangeCalculatorService.class);
    ...
    private final transient JMXEnabledThreadPoolExecutor executor = new JMXEnabledThreadPoolExecutor(1, Integer.MAX_VALUE, TimeUnit.SECONDS, new LinkedBlockingQueue<>(1), new NamedThreadFactory("PendingRangeCalculator"), "internal");

    private transient AtomicInteger updateJobs = new AtomicInteger(0);
    ...
    private static class PendingRangeTask implements Runnable {
        ...
        private final transient AtomicInteger updateJobs;
