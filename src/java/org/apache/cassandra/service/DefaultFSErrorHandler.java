...
public class DefaultFSErrorHandler implements FSErrorHandler {
    ...
    public static transient org.slf4j.Logger logger_IC = org.slf4j.LoggerFactory.getLogger(DefaultFSErrorHandler.class);

    public static transient org.slf4j.Logger logger_IC = org.slf4j.LoggerFactory.getLogger(DefaultFSErrorHandler.class);

    private static final transient Logger logger = LoggerFactory.getLogger(DefaultFSErrorHandler.class);
    ...
    private static void handleStartupFSError(Throwable t) {
        switch(DatabaseDescriptor.getDiskFailurePolicy()) {
            ...
            case stop:
            case die:
                logger.error("Exiting forcefully due to file system exception on startup, disk failure policy \"{}\"", DatabaseDescriptor.getDiskFailurePolicy(), t);
