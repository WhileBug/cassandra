...
public abstract class AbstractReadRepair<E extends Endpoints<E>, P extends ReplicaPlan.ForRead<E>> implements ReadRepair<E, P> {
    ...
    public static transient org.slf4j.Logger logger_IC = org.slf4j.LoggerFactory.getLogger(AbstractReadRepair.class);
    ...
    private volatile transient DigestRepair<E, P> digestRepair = null;

    private static class DigestRepair<E extends Endpoints<E>, P extends ReplicaPlan.ForRead<E>> {

        private final transient DataResolver<E, P> dataResolver;

        private final transient ReadCallback<E, P> readCallback;

        private final transient Consumer<PartitionIterator> resultConsumer;
