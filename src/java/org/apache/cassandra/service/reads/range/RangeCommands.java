...
public class RangeCommands {
    ...
    public static transient org.slf4j.Logger logger_IC = org.slf4j.LoggerFactory.getLogger(RangeCommands.class);

    private static final transient Logger logger = LoggerFactory.getLogger(RangeCommandIterator.class);

    private static final transient double CONCURRENT_SUBREQUESTS_MARGIN = 0.10;
     ...
     */
    private static final transient int MAX_CONCURRENT_RANGE_REQUESTS = Math.max(1, Integer.getInteger("cassandra.max_concurrent_range_requests", FBUtilities.getAvailableProcessors() * 10));
