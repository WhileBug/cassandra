...
public class CassandraDaemon {
    ...
    public static transient org.slf4j.Logger logger_IC = org.slf4j.LoggerFactory.getLogger(CassandraDaemon.class);

    public static transient org.slf4j.Logger logger_IC = org.slf4j.LoggerFactory.getLogger(CassandraDaemon.class);

    public static final transient String MBEAN_NAME = "org.apache.cassandra.db:type=NativeAccess";
    ...
    @VisibleForTesting
    public static transient Runnable SPECULATION_THRESHOLD_UPDATER = () -> {
        try {
    ...
    static final transient CassandraDaemon instance = new CassandraDaemon();

    private volatile transient NativeTransportService nativeTransportService;

    private transient JMXConnectorServer jmxServer;

    private final transient boolean runManaged;

    protected final transient StartupChecks startupChecks;

    private transient boolean setupCompleted;
