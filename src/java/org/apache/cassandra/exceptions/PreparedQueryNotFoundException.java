...
public class PreparedQueryNotFoundException extends RequestValidationException {
    ...
    public static transient org.slf4j.Logger logger_IC = org.slf4j.LoggerFactory.getLogger(PreparedQueryNotFoundException.class);

    public final transient MD5Digest id;
