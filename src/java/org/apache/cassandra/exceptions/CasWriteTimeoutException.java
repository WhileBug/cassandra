...
public class CasWriteTimeoutException extends WriteTimeoutException {
    ...
    public static transient org.slf4j.Logger logger_IC = org.slf4j.LoggerFactory.getLogger(CasWriteTimeoutException.class);

    public static transient org.slf4j.Logger logger_IC = org.slf4j.LoggerFactory.getLogger(CasWriteTimeoutException.class);

    public final transient int contentions;
