...
public class PendingRangeMaps implements Iterable<Map.Entry<Range<Token>, EndpointsForRange.Builder>> {
    ...
    public static transient org.slf4j.Logger logger_IC = org.slf4j.LoggerFactory.getLogger(PendingRangeMaps.class);
    ...
    private final transient NavigableMap<Range<Token>, EndpointsForRange.Builder> ascendingMap;
     ...
     */
    private static final transient Comparator<Range<Token>> ascendingComparator = (o1, o2) -> {
    ...
    private final transient NavigableMap<Range<Token>, EndpointsForRange.Builder> descendingMap;
     ...
     */
    private static final transient Comparator<Range<Token>> descendingComparator = (o1, o2) -> {
    ...
    private final transient NavigableMap<Range<Token>, EndpointsForRange.Builder> ascendingMapForWrapAround;
     ...
     * the tailMap.
     */
    private static final transient Comparator<Range<Token>> ascendingComparatorForWrapAround = (o1, o2) -> {
        int res = o1.right.compareTo(o2.right);
        if (res != 0)
            return res;
    ...
    private final transient NavigableMap<Range<Token>, EndpointsForRange.Builder> descendingMapForWrapAround;
     ...
     */
    private static final transient Comparator<Range<Token>> descendingComparatorForWrapAround = (o1, o2) -> {
        int res = o2.left.compareTo(o1.left);
        if (res != 0)
            return res;
