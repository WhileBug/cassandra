...
public abstract class ReplicaMultimap<K, C extends ReplicaCollection<?>> {
    ...
    public static transient org.slf4j.Logger logger_IC = org.slf4j.LoggerFactory.getLogger(ReplicaMultimap.class);

    final transient Map<K, C> map;
