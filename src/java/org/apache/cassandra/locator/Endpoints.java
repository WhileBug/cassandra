...
public abstract class Endpoints<E extends Endpoints<E>> extends AbstractReplicaCollection<E> {
    ...
    public static transient org.slf4j.Logger logger_IC = org.slf4j.LoggerFactory.getLogger(Endpoints.class);

    static ReplicaMap<InetAddressAndPort> endpointMap(ReplicaList list) {
        return new ReplicaMap<>(list, Replica::endpoint);
    }

    static final transient ReplicaMap<InetAddressAndPort> EMPTY_MAP = endpointMap(EMPTY_LIST);
    ...
    transient ReplicaMap<InetAddressAndPort> byEndpoint;
