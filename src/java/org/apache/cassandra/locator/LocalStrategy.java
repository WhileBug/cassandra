...
public class LocalStrategy extends AbstractReplicationStrategy {
    ...
    public static transient org.slf4j.Logger logger_IC = org.slf4j.LoggerFactory.getLogger(LocalStrategy.class);

    public static transient org.slf4j.Logger logger_IC = org.slf4j.LoggerFactory.getLogger(LocalStrategy.class);

    private static final transient ReplicationFactor RF = ReplicationFactor.fullOnly(1);

    private final transient EndpointsForRange replicas;
