...
public class ReconnectableSnitchHelper implements IEndpointStateChangeSubscriber {
    ...
    public static transient org.slf4j.Logger logger_IC = org.slf4j.LoggerFactory.getLogger(ReconnectableSnitchHelper.class);

    public static transient org.slf4j.Logger logger_IC = org.slf4j.LoggerFactory.getLogger(ReconnectableSnitchHelper.class);

    private static final transient Logger logger = LoggerFactory.getLogger(ReconnectableSnitchHelper.class);

    private final transient IEndpointSnitch snitch;

    private final transient String localDc;
