...
public class SimpleSnitch extends AbstractEndpointSnitch {
    ...
    public static transient org.slf4j.Logger logger_IC = org.slf4j.LoggerFactory.getLogger(SimpleSnitch.class);

    public static transient org.slf4j.Logger logger_IC = org.slf4j.LoggerFactory.getLogger(SimpleSnitch.class);

    public static final transient String DATA_CENTER_NAME = "datacenter1";

    public static final transient String RACK_NAME = "rack1";
