...
public class SnitchProperties {
    ...
    public static transient org.slf4j.Logger logger_IC = org.slf4j.LoggerFactory.getLogger(SnitchProperties.class);

    private static final transient Logger logger = LoggerFactory.getLogger(SnitchProperties.class);

    public static final transient String RACKDC_PROPERTY_FILENAME = "cassandra-rackdc.properties";
    ...
    public SnitchProperties() {
        ...
        try {
            ...
            // catch block handles potential NPE
