...
public class ReplicationFactor {
    ...
    public static transient org.slf4j.Logger logger_IC = org.slf4j.LoggerFactory.getLogger(ReplicationFactor.class);

    public static transient org.slf4j.Logger logger_IC = org.slf4j.LoggerFactory.getLogger(ReplicationFactor.class);

    public static final transient ReplicationFactor ZERO = new ReplicationFactor(0);

    public final transient int allReplicas;

    public final transient int fullReplicas;
