...
public class Ec2Snitch extends AbstractNetworkTopologySnitch {
    ...
    public static transient org.slf4j.Logger logger_IC = org.slf4j.LoggerFactory.getLogger(Ec2Snitch.class);

    public static transient org.slf4j.Logger logger_IC = org.slf4j.LoggerFactory.getLogger(Ec2Snitch.class);

    protected static final transient Logger logger = LoggerFactory.getLogger(Ec2Snitch.class);

    private static final transient String SNITCH_PROP_NAMING_SCHEME = "ec2_naming_scheme";

    static final transient String EC2_NAMING_LEGACY = "legacy";

    private static final transient String EC2_NAMING_STANDARD = "standard";

    private static final transient String ZONE_NAME_QUERY_URL = "http://169.254.169.254/latest/meta-data/placement/availability-zone";
    ...
    final transient String ec2region;

    private final transient String ec2zone;

    private final transient boolean usingLegacyNaming;
