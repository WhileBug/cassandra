...
public class GossipingPropertyFileSnitch extends // implements IEndpointStateChangeSubscriber
AbstractNetworkTopologySnitch {

    public static transient org.slf4j.Logger logger_IC = org.slf4j.LoggerFactory.getLogger(GossipingPropertyFileSnitch.class);

    private static final transient Logger logger = LoggerFactory.getLogger(GossipingPropertyFileSnitch.class);

    private transient PropertyFileSnitch psnitch;

    private final transient String myDC;

    private final transient String myRack;

    private final transient boolean preferLocal;

    private final transient AtomicReference<ReconnectableSnitchHelper> snitchHelperReference;

    private transient Map<InetAddressAndPort, Map<String, String>> savedEndpoints;

    private static final transient String DEFAULT_DC = "UNKNOWN_DC";

    private static final transient String DEFAULT_RACK = "UNKNOWN_RACK";
