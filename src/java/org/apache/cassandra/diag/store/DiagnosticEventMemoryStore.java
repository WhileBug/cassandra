...
public final class DiagnosticEventMemoryStore implements DiagnosticEventStore<Long> {
    ...
    public static transient org.slf4j.Logger logger_IC = org.slf4j.LoggerFactory.getLogger(DiagnosticEventMemoryStore.class);

    private final transient AtomicLong lastKey = new AtomicLong(0);

    private transient int maxSize = 200;
    ...
    private final transient ConcurrentSkipListMap<Long, DiagnosticEvent> events = new ConcurrentSkipListMap<>(Comparator.reverseOrder());
