...
public final class DiagnosticEventPersistence {
    ...
    public static transient org.slf4j.Logger logger_IC = org.slf4j.LoggerFactory.getLogger(DiagnosticEventPersistence.class);

    public static transient org.slf4j.Logger logger_IC = org.slf4j.LoggerFactory.getLogger(DiagnosticEventPersistence.class);

    private static final transient Logger logger = LoggerFactory.getLogger(DiagnosticEventPersistence.class);

    private static final transient DiagnosticEventPersistence instance = new DiagnosticEventPersistence();

    private final transient Map<Class, DiagnosticEventStore<Long>> stores = new ConcurrentHashMap<>();

    private final transient Consumer<DiagnosticEvent> eventConsumer = this::onEvent;
