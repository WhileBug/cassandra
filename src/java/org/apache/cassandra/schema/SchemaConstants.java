...
public final class SchemaConstants {
    ...
    public static transient org.slf4j.Logger logger_IC = org.slf4j.LoggerFactory.getLogger(SchemaConstants.class);

    public static transient org.slf4j.Logger logger_IC = org.slf4j.LoggerFactory.getLogger(SchemaConstants.class);

    public static final transient Pattern PATTERN_WORD_CHARS = Pattern.compile("\\w+");

    public static final transient String SYSTEM_KEYSPACE_NAME = "system";

    public static final transient String SCHEMA_KEYSPACE_NAME = "system_schema";

    public static final transient String TRACE_KEYSPACE_NAME = "system_traces";

    public static final transient String AUTH_KEYSPACE_NAME = "system_auth";

    public static final transient String DISTRIBUTED_KEYSPACE_NAME = "system_distributed";

    public static final transient String VIRTUAL_SCHEMA = "system_virtual_schema";

    public static final transient String VIRTUAL_VIEWS = "system_views";

    /* system keyspace names (the ones with LocalStrategy replication strategy) */
    public static final transient Set<String> LOCAL_SYSTEM_KEYSPACE_NAMES = ImmutableSet.of(SYSTEM_KEYSPACE_NAME, SCHEMA_KEYSPACE_NAME);

    /* replicate system keyspace names (the ones with a "true" replication strategy) */
    public static final transient Set<String> REPLICATED_SYSTEM_KEYSPACE_NAMES = ImmutableSet.of(TRACE_KEYSPACE_NAME, AUTH_KEYSPACE_NAME, DISTRIBUTED_KEYSPACE_NAME);
     ...
     */
    public static final transient int NAME_LENGTH = 48;

    // 59adb24e-f3cd-3e02-97f0-5b395827453f
    public static final transient UUID emptyVersion;

    public static final transient List<String> LEGACY_AUTH_TABLES = Arrays.asList("credentials", "users", "permissions");
    ...
    public static boolean isSystemKeyspace(String keyspaceName) {
        return isLocalSystemKeyspace(keyspaceName) || isReplicatedSystemKeyspace(keyspaceName) || isVirtualSystemKeyspace(keyspaceName);
    }
}
