...
public final class TriggerMetadata {
    ...
    public static transient org.slf4j.Logger logger_IC = org.slf4j.LoggerFactory.getLogger(TriggerMetadata.class);
    ...
    public final transient String classOption;
    ...
    public String toString() {
        return MoreObjects.toStringHelper(this).add("name", name).add("class", classOption).toString();
    }
}
