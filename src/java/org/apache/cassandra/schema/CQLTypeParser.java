...
public final class CQLTypeParser {
    ...
    public static transient org.slf4j.Logger logger_IC = org.slf4j.LoggerFactory.getLogger(CQLTypeParser.class);

    public static transient org.slf4j.Logger logger_IC = org.slf4j.LoggerFactory.getLogger(CQLTypeParser.class);

    private static final transient ImmutableSet<String> PRIMITIVE_TYPES;

    static {
        ImmutableSet.Builder<String> builder = ImmutableSet.builder();
        for (CQL3Type.Native primitive : CQL3Type.Native.values()) builder.add(primitive.name().toLowerCase());
