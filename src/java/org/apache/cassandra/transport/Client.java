...
public class Client extends SimpleClient {
    ...
    public static transient org.slf4j.Logger logger_IC = org.slf4j.LoggerFactory.getLogger(Client.class);

    private final transient SimpleEventHandler eventHandler = new SimpleEventHandler();
