...
public class InitialConnectionHandler extends ByteToMessageDecoder {
    ...
    public static transient org.slf4j.Logger logger_IC = org.slf4j.LoggerFactory.getLogger(InitialConnectionHandler.class);

    private static final transient Logger logger = LoggerFactory.getLogger(InitialConnectionHandler.class);

    final transient Envelope.Decoder decoder;

    final transient Connection.Factory factory;

    final transient PipelineConfigurator configurator;
