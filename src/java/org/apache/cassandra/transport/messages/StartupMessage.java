...
public class StartupMessage extends Message.Request {
    ...
    public static transient org.slf4j.Logger logger_IC = org.slf4j.LoggerFactory.getLogger(StartupMessage.class);

    public static final transient String CQL_VERSION = "CQL_VERSION";

    public static final transient String COMPRESSION = "COMPRESSION";

    public static final transient String PROTOCOL_VERSIONS = "PROTOCOL_VERSIONS";

    public static final transient String DRIVER_NAME = "DRIVER_NAME";

    public static final transient String DRIVER_VERSION = "DRIVER_VERSION";

    public static final transient String THROW_ON_OVERLOAD = "THROW_ON_OVERLOAD";

    public static final transient Message.Codec<StartupMessage> codec = new Message.Codec<StartupMessage>() {
    ...
    private static Map<String, String> upperCaseKeys(Map<String, String> options) {
        ...
        for (Map.Entry<String, String> entry : options.entrySet()) newMap.put(entry.getKey().toUpperCase(), entry.getValue());
        return newMap;
    }
