...
public class SupportedMessage extends Message.Response {
    ...
    public static transient org.slf4j.Logger logger_IC = org.slf4j.LoggerFactory.getLogger(SupportedMessage.class);

    public static final transient Message.Codec<SupportedMessage> codec = new Message.Codec<SupportedMessage>() {
    ...
    public final transient Map<String, List<String>> supported;
