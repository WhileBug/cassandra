...
public class UnsupportedMessageCodec<T extends Message> implements Message.Codec<T> {
    ...
    public static transient org.slf4j.Logger logger_IC = org.slf4j.LoggerFactory.getLogger(UnsupportedMessageCodec.class);

    public static transient org.slf4j.Logger logger_IC = org.slf4j.LoggerFactory.getLogger(UnsupportedMessageCodec.class);

    public final static transient UnsupportedMessageCodec instance = new UnsupportedMessageCodec();

    private static final transient Logger logger = LoggerFactory.getLogger(UnsupportedMessageCodec.class);
