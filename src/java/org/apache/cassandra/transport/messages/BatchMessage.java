...
public class BatchMessage extends Message.Request {
    ...
    public static transient org.slf4j.Logger logger_IC = org.slf4j.LoggerFactory.getLogger(BatchMessage.class);

    public static final transient Message.Codec<BatchMessage> codec = new Message.Codec<BatchMessage>() {
    ...
    public final transient BatchStatement.Type batchType;

    public final transient List<Object> queryOrIdList;

    public final transient List<List<ByteBuffer>> values;
