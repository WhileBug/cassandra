...
public class ExecuteMessage extends Message.Request {
    ...
    public static transient org.slf4j.Logger logger_IC = org.slf4j.LoggerFactory.getLogger(ExecuteMessage.class);

    public static transient org.slf4j.Logger logger_IC = org.slf4j.LoggerFactory.getLogger(ExecuteMessage.class);

    private static final transient NoSpamLogger nospam = NoSpamLogger.getLogger(logger, 10, TimeUnit.MINUTES);

    public static final transient Message.Codec<ExecuteMessage> codec = new Message.Codec<ExecuteMessage>() {
    ...
    protected Message.Response execute(QueryState state, long queryStartNanoTime, boolean traceRequest) {
        ...
        try {
            ...
            if (// We can not reliably detect inconsistencies for batches yet
            !prepared.fullyQualified && !Objects.equals(state.getClientState().getRawKeyspace(), prepared.keyspace) && !(prepared.statement instanceof BatchStatement)) {
