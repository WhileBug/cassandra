...
public class RegisterMessage extends Message.Request {
    ...
    public static transient org.slf4j.Logger logger_IC = org.slf4j.LoggerFactory.getLogger(RegisterMessage.class);

    public static final transient Message.Codec<RegisterMessage> codec = new Message.Codec<RegisterMessage>() {
        ...
        public RegisterMessage decode(ByteBuf body, ProtocolVersion version) {
            ...
            for (int i = 0; i < length; ++i) eventTypes.add(CBUtil.readEnumValue(Event.Type.class, body));
    ...
    public final transient List<Event.Type> eventTypes;
