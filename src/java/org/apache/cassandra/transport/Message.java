...
public abstract class Message {
    ...
    protected static final transient Logger logger = LoggerFactory.getLogger(Message.class);
    ...
    private transient int streamId;

    private transient Envelope source;

    private transient Map<String, ByteBuffer> customPayload;

    protected transient ProtocolVersion forcedProtocolVersion = null;
    ...
    public static abstract class Request extends Message {
        ...
        private transient boolean tracingRequested;
    ...
    public static abstract class Response extends Message {
        ...
        protected transient UUID tracingId;

        protected transient List<String> warnings;
    ...
    public Envelope encode(ProtocolVersion version) {
        ...
        try {
            ...
            ProtocolVersion responseVersion = forcedProtocolVersion == null ? version : forcedProtocolVersion;
        ...
        private static class RequestDecoder extends Decoder<Request> {
            ...
            Request decode(Channel channel, Envelope request) {
                if (request.header.type.direction != Direction.REQUEST)
                    throw new ProtocolException(String.format("Unexpected RESPONSE message %s, expecting REQUEST", request.header.type));
        ...
        private static class ResponseDecoder extends Decoder<Response> {
            ...
            Response decode(Channel channel, Envelope response) {
                if (response.header.type.direction != Direction.RESPONSE)
                    throw new ProtocolException(String.format("Unexpected REQUEST message %s, expecting RESPONSE", response.header.type));
                return (Response) decodeMessage(channel, response);
            }
        }
    }

    private static final transient Decoder.RequestDecoder REQUEST_DECODER = new Decoder.RequestDecoder();

    private static final transient Decoder.ResponseDecoder RESPONSE_DECODER = new Decoder.ResponseDecoder();
