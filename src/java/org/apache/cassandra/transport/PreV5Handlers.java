...
public class PreV5Handlers {
    ...
    public static transient org.slf4j.Logger logger_IC = org.slf4j.LoggerFactory.getLogger(PreV5Handlers.class);
    ...
    public static class LegacyDispatchHandler extends SimpleChannelInboundHandler<Message.Request> {
        ...
        private static final transient Logger logger = LoggerFactory.getLogger(LegacyDispatchHandler.class);

        private final transient Dispatcher dispatcher;

        private final transient ClientResourceLimits.Allocator endpointPayloadTracker;
         ...
         */
        private transient long channelPayloadBytesInFlight;
        ...
        private boolean shouldHandleRequest(ChannelHandlerContext ctx, Message.Request request) {
            ...
            if (endpointPayloadTracker.tryAllocate(requestSize) != ResourceLimits.Outcome.SUCCESS) {
                if (request.connection.isThrowOnOverload()) {
                    ...
                    logger.trace("Discarded request of size: {}. InflightChannelRequestPayload: {}, {}, Request: {}", requestSize, channelPayloadBytesInFlight, endpointPayloadTracker.toString(), request);
    ...
    public static class ProtocolDecoder extends MessageToMessageDecoder<Envelope> {
        ...
        public static final transient ProtocolDecoder instance = new ProtocolDecoder();
    ...
    public static class ProtocolEncoder extends MessageToMessageEncoder<Message> {
        ...
        public static final transient ProtocolEncoder instance = new ProtocolEncoder();
    ...
    public static final class ExceptionHandler extends ChannelInboundHandlerAdapter {
        ...
        public static final transient ExceptionHandler instance = new ExceptionHandler();
        ...
        private static boolean isFatal(Throwable cause) {
            // this matches previous versions which didn't annotate exceptions as fatal or not
