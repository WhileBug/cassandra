...
public class Connection {
    ...
    public static transient org.slf4j.Logger logger_IC = org.slf4j.LoggerFactory.getLogger(Connection.class);

    public static transient org.slf4j.Logger logger_IC = org.slf4j.LoggerFactory.getLogger(Connection.class);

    static final transient AttributeKey<Connection> attributeKey = AttributeKey.valueOf("CONN");
    ...
    private transient boolean throwOnOverload;

    private volatile transient Compressor preV5MessageCompressor;
