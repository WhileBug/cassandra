...
public class JMXServerUtils {
    ...
    public static transient org.slf4j.Logger logger_IC = org.slf4j.LoggerFactory.getLogger(JMXServerUtils.class);

    private static final transient Logger logger = LoggerFactory.getLogger(JMXServerUtils.class);
    ...
    private static class JMXPluggableAuthenticatorWrapper implements JMXAuthenticator {
        ...
        private static final transient MethodHandle ctorHandle;
    ...
    private static class JmxRegistry extends sun.rmi.registry.RegistryImpl {
        ...
        private final transient String lookupName;

        private transient Remote remoteServerStub;

        JmxRegistry(final int port, final RMIClientSocketFactory csf, RMIServerSocketFactory ssf, final String lookupName) throws RemoteException {
            super(port, csf, ssf);
