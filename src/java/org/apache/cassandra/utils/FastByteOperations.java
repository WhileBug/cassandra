...
public class FastByteOperations {
    ...
    public static transient org.slf4j.Logger logger_IC = org.slf4j.LoggerFactory.getLogger(FastByteOperations.class);
    ...
    private static class BestHolder {
        ...
        static final transient String UNSAFE_COMPARER_NAME = FastByteOperations.class.getName() + "$UnsafeOperations";

        static final transient ByteOperations BEST = getBest();
    ...
    public static final class UnsafeOperations implements ByteOperations {
        ...
        static final transient Unsafe theUnsafe;

        /**
         * The offset to the first element in a byte array.
         */
        static final transient long BYTE_ARRAY_BASE_OFFSET;

        static final transient long DIRECT_BUFFER_ADDRESS_OFFSET;
        ...
        static final transient boolean BIG_ENDIAN = ByteOrder.nativeOrder().equals(ByteOrder.BIG_ENDIAN);
        ...
        private static final transient long UNSAFE_COPY_THRESHOLD = 1 << 20;

        private static final transient long MIN_COPY_THRESHOLD = 6;
