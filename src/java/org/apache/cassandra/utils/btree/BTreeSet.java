...
public class BTreeSet<V> implements NavigableSet<V>, List<V> {
    ...
    public static transient org.slf4j.Logger logger_IC = org.slf4j.LoggerFactory.getLogger(BTreeSet.class);

    public static transient org.slf4j.Logger logger_IC = org.slf4j.LoggerFactory.getLogger(BTreeSet.class);

    protected final transient Comparator<? super V> comparator;

    protected final transient Object[] tree;
    ...
    public int hashCode() {
        ...
        int result = 1;
        for (V v : this) result = 31 * result + Objects.hashCode(v);
        return result;
    }
    ...
    public static class BTreeRange<V> extends BTreeSet<V> {
        ...
        // both inclusive
        protected final transient int lowerBound, upperBound;
    ...
    public static class Builder<V> {
        ...
        final transient BTree.Builder<V> wrapped;
