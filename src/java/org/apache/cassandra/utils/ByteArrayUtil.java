...
public class ByteArrayUtil {
    ...
    public static transient org.slf4j.Logger logger_IC = org.slf4j.LoggerFactory.getLogger(ByteArrayUtil.class);

    public static transient org.slf4j.Logger logger_IC = org.slf4j.LoggerFactory.getLogger(ByteArrayUtil.class);

    public static final transient byte[] EMPTY_BYTE_ARRAY = new byte[0];
    ...
    public static void writeWithShortLength(byte[] buffer, DataOutput out) throws IOException {
        ...
        assert length <= FBUtilities.MAX_UNSIGNED_SHORT : String.format("Attempted serializing to buffer exceeded maximum of %s bytes: %s", FBUtilities.MAX_UNSIGNED_SHORT, length);
