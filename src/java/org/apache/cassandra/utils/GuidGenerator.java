...
public class GuidGenerator {
    ...
    public static transient org.slf4j.Logger logger_IC = org.slf4j.LoggerFactory.getLogger(GuidGenerator.class);

    public static transient org.slf4j.Logger logger_IC = org.slf4j.LoggerFactory.getLogger(GuidGenerator.class);

    private static final transient Random myRand;

    private static final transient SecureRandom mySecureRand;

    private static final transient String s_id;
