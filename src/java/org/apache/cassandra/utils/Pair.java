...
public class Pair<T1, T2> {
    ...
    public static transient org.slf4j.Logger logger_IC = org.slf4j.LoggerFactory.getLogger(Pair.class);

    public static transient org.slf4j.Logger logger_IC = org.slf4j.LoggerFactory.getLogger(Pair.class);

    public final transient T1 left;

    public final transient T2 right;
