...
public class LogbackLoggingSupport implements LoggingSupport {
    ...
    public static transient org.slf4j.Logger logger_IC = org.slf4j.LoggerFactory.getLogger(LogbackLoggingSupport.class);

    private static final transient org.slf4j.Logger logger = LoggerFactory.getLogger(LogbackLoggingSupport.class);
    ...
    public void setLoggingLevel(String classQualifier, String rawLevel) throws Exception {
        ...
        if (StringUtils.isBlank(classQualifier) && StringUtils.isBlank(rawLevel)) {
            ...
            return;
        } else // classQualifier is set, but blank level given
