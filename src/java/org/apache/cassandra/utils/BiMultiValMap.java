...
public class BiMultiValMap<K, V> implements Map<K, V> {
    ...
    public static transient org.slf4j.Logger logger_IC = org.slf4j.LoggerFactory.getLogger(BiMultiValMap.class);

    protected final transient Map<K, V> forwardMap;

    protected final transient Multimap<V, K> reverseMap;
    ...
    public Collection<K> removeValue(V value) {
        ...
        for (K key : keys) forwardMap.remove(key);
        return keys;
    }
