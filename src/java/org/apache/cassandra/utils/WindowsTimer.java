...
public final class WindowsTimer {
    ...
    public static transient org.slf4j.Logger logger_IC = org.slf4j.LoggerFactory.getLogger(WindowsTimer.class);

    public static transient org.slf4j.Logger logger_IC = org.slf4j.LoggerFactory.getLogger(WindowsTimer.class);

    private static final transient Logger logger = LoggerFactory.getLogger(WindowsTimer.class);
