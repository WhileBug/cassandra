...
public class Interval<C, D> {
    ...
    public static transient org.slf4j.Logger logger_IC = org.slf4j.LoggerFactory.getLogger(Interval.class);

    public final transient C min;

    public final transient C max;

    public final transient D data;
    ...
    private static final transient AsymmetricOrdering<Interval<Comparable, Object>, Comparable> minOrdering = new AsymmetricOrdering<Interval<Comparable, Object>, Comparable>() {
    ...
    private static final transient AsymmetricOrdering<Interval<Comparable, Object>, Comparable> maxOrdering = new AsymmetricOrdering<Interval<Comparable, Object>, Comparable>() {
    ...
    private static final transient AsymmetricOrdering<Interval<Comparable, Object>, Comparable> reverseMaxOrdering = maxOrdering.reverse();
