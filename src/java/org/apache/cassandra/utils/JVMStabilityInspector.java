...
public final class JVMStabilityInspector {
    ...
    public static transient org.slf4j.Logger logger_IC = org.slf4j.LoggerFactory.getLogger(JVMStabilityInspector.class);

    private static final transient Logger logger = LoggerFactory.getLogger(JVMStabilityInspector.class);

    private static transient Killer killer = new Killer();

    private static transient Object lock = new Object();

    private static transient boolean printingHeapHistogram;

    // It is used for unit test
    public static transient OnKillHook killerHook;
     ...
     */
    // Exclude from just in time compilation.
    @Exclude
    ...
    public static class Killer {
        ...
        private final transient AtomicBoolean killing = new AtomicBoolean();
