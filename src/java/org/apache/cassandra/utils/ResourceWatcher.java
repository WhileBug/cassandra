...
public class ResourceWatcher {
    ...
    public static transient org.slf4j.Logger logger_IC = org.slf4j.LoggerFactory.getLogger(ResourceWatcher.class);
    ...
    public static class WatchedResource implements Runnable {
        ...
        private static final transient Logger logger = LoggerFactory.getLogger(WatchedResource.class);

        private final transient String resource;

        private final transient Runnable callback;

        private transient long lastLoaded;
