...
public class IntervalLock extends ReentrantReadWriteLock {
    ...
    public static transient org.slf4j.Logger logger_IC = org.slf4j.LoggerFactory.getLogger(IntervalLock.class);

    public static transient org.slf4j.Logger logger_IC = org.slf4j.LoggerFactory.getLogger(IntervalLock.class);

    private final transient AtomicLong lastAcquire = new AtomicLong();
