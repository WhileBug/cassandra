...
public class HistogramBuilder {
    ...
    public static transient org.slf4j.Logger logger_IC = org.slf4j.LoggerFactory.getLogger(HistogramBuilder.class);

    public static final transient long[] EMPTY_LONG_ARRAY = new long[] {};

    public static final transient long[] ZERO = new long[] { 0 };
    ...
    private transient long[] values = new long[10];
