...
public class NativeLibraryDarwin implements NativeLibraryWrapper {
    ...
    public static transient org.slf4j.Logger logger_IC = org.slf4j.LoggerFactory.getLogger(NativeLibraryDarwin.class);

    private static final transient Logger logger = LoggerFactory.getLogger(NativeLibraryDarwin.class);
