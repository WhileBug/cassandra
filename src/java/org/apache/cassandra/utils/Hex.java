...
public class Hex {
    ...
    public static transient org.slf4j.Logger logger_IC = org.slf4j.LoggerFactory.getLogger(Hex.class);

    public static transient org.slf4j.Logger logger_IC = org.slf4j.LoggerFactory.getLogger(Hex.class);

    private static final transient Constructor<String> stringConstructor = getProtectedConstructor(String.class, int.class, int.class, char[].class);

    private final static transient byte[] charToByte = new byte[256];

    private static final transient Logger logger = LoggerFactory.getLogger(Hex.class);

    // package protected for use by ByteBufferUtil. Do not modify this array !!
    static final transient char[] byteToChar = new char[16];
