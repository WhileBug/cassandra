...
public class Range<T extends RingPosition<T>> extends AbstractBounds<T> implements Comparable<Range<T>>, Serializable {
    ...
    public static transient org.slf4j.Logger logger_IC = org.slf4j.LoggerFactory.getLogger(Range.class);

    public static final transient long serialVersionUID = 1L;
    ...
    public static class OrderedRangeContainmentChecker implements Predicate<Token> {
        ...
        private final transient Iterator<Range<Token>> normalizedRangesIterator;

        private transient Token lastToken = null;

        private transient Range<Token> currentRange;
