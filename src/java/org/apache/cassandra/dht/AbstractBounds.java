...
public abstract class AbstractBounds<T extends RingPosition<T>> implements Serializable {
    ...
    public static transient org.slf4j.Logger logger_IC = org.slf4j.LoggerFactory.getLogger(AbstractBounds.class);

    public static transient org.slf4j.Logger logger_IC = org.slf4j.LoggerFactory.getLogger(AbstractBounds.class);

    private static final transient long serialVersionUID = 1L;

    public static final transient IPartitionerDependentSerializer<AbstractBounds<Token>> tokenSerializer = new AbstractBoundsSerializer<Token>(Token.serializer);

    public static final transient IPartitionerDependentSerializer<AbstractBounds<PartitionPosition>> rowPositionSerializer = new AbstractBoundsSerializer<PartitionPosition>(PartitionPosition.serializer);
    ...
    public final transient T left;

    public final transient T right;
    ...
    public static class AbstractBoundsSerializer<T extends RingPosition<T>> implements IPartitionerDependentSerializer<AbstractBounds<T>> {
        ...
        private static final transient int IS_TOKEN_FLAG = 0x01;

        private static final transient int START_INCLUSIVE_FLAG = 0x02;

        private static final transient int END_INCLUSIVE_FLAG = 0x04;

        transient IPartitionerDependentSerializer<T> serializer;
    ...
    public static class Boundary<T extends RingPosition<T>> {
        ...
        public final transient T boundary;
