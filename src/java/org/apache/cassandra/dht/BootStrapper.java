...
public class BootStrapper extends ProgressEventNotifierSupport {
    ...
    public static transient org.slf4j.Logger logger_IC = org.slf4j.LoggerFactory.getLogger(BootStrapper.class);

    public static transient org.slf4j.Logger logger_IC = org.slf4j.LoggerFactory.getLogger(BootStrapper.class);

    private static final transient Logger logger = LoggerFactory.getLogger(BootStrapper.class);

    /* endpoint that needs to be bootstrapped */
    protected final transient InetAddressAndPort address;

    /* token of the node being bootstrapped. */
    protected final transient Collection<Token> tokens;

    protected final transient TokenMetadata tokenMetadata;
