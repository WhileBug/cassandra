...
class ReplicationAwareTokenAllocator<Unit> extends TokenAllocatorBase<Unit> {
    ...
    public static transient org.slf4j.Logger logger_IC = org.slf4j.LoggerFactory.getLogger(ReplicationAwareTokenAllocator.class);

    public static transient org.slf4j.Logger logger_IC = org.slf4j.LoggerFactory.getLogger(ReplicationAwareTokenAllocator.class);

    final transient Multimap<Unit, Token> unitToTokens;

    final transient int replicas;
    ...
    private static class UnitAdjustmentTracker<Unit> {
        ...
        transient UnitInfo<Unit> unitsChain;
    ...
    private abstract class GroupVisitor {
        ...
        transient GroupInfo groupChain = GroupInfo.TERMINATOR;

        transient int seen = 0;
    ...
    private static class CandidateInfo<Unit> extends BaseTokenInfo<Unit, CandidateInfo<Unit>> {
        ...
        final transient TokenInfo<Unit> split;
