...
public abstract class TokenAllocatorBase<Unit> implements TokenAllocator<Unit> {
    ...
    public static transient org.slf4j.Logger logger_IC = org.slf4j.LoggerFactory.getLogger(TokenAllocatorBase.class);

    static final transient double MIN_INITIAL_SPLITS_RATIO = 1.0 - 1.0 / Math.sqrt(5.0);

    static final transient double MAX_INITIAL_SPLITS_RATIO = MIN_INITIAL_SPLITS_RATIO + 0.075;

    final transient NavigableMap<Token, Unit> sortedTokens;

    final transient ReplicationStrategy<Unit> strategy;
    ...
    static class GroupInfo {
         ...
         */
        transient GroupInfo prevSeen = null;

        /**
         * Same marker/chain used by populateTokenInfo.
         */
        transient GroupInfo prevPopulate = null;

        /**
         * Value used as terminator for seen chains.
         */
        static transient GroupInfo TERMINATOR = new GroupInfo(null);
    ...
    static class UnitInfo<Unit> {
        ...
        public String toString() {
            return String.format("%s%s(%.2e)%s", unit, unit == group.group ? (group.prevSeen != null ? "*" : "") : ":" + group.toString(), ownership, prevUsed != null ? (prevUsed == this ? "#" : "->" + prevUsed.toString()) : "");
        }
    }
    ...
    static class BaseTokenInfo<Unit, T extends BaseTokenInfo<Unit, T>> extends CircularList<T> {
        ...
        final transient UnitInfo<Unit> owningUnit;
         ...
         */
        transient Token replicationStart;
