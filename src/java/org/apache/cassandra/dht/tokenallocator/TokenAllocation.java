...
public class TokenAllocation {
    ...
    public static transient org.slf4j.Logger logger_IC = org.slf4j.LoggerFactory.getLogger(TokenAllocation.class);

    public static final transient double WARN_STDEV_GROWTH = 0.05;

    private static final transient Logger logger = LoggerFactory.getLogger(TokenAllocation.class);

    final transient TokenMetadata tokenMetadata;

    final transient AbstractReplicationStrategy replicationStrategy;

    final transient int numTokens;

    final transient Map<String, Map<String, StrategyAdapter>> strategyByRackDc = new HashMap<>();
