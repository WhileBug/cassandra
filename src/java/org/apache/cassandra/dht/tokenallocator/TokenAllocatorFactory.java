...
public class TokenAllocatorFactory {
    ...
    public static transient org.slf4j.Logger logger_IC = org.slf4j.LoggerFactory.getLogger(TokenAllocatorFactory.class);

    public static transient org.slf4j.Logger logger_IC = org.slf4j.LoggerFactory.getLogger(TokenAllocatorFactory.class);

    private static final transient Logger logger = LoggerFactory.getLogger(TokenAllocatorFactory.class);
