...
public class NoReplicationTokenAllocator<Unit> extends TokenAllocatorBase<Unit> {
    ...
    public static transient org.slf4j.Logger logger_IC = org.slf4j.LoggerFactory.getLogger(NoReplicationTokenAllocator.class);

    public static transient org.slf4j.Logger logger_IC = org.slf4j.LoggerFactory.getLogger(NoReplicationTokenAllocator.class);

    transient PriorityQueue<Weighted<UnitInfo>> sortedUnits = Queues.newPriorityQueue();

    transient Map<Unit, PriorityQueue<Weighted<TokenInfo>>> tokensInUnits = Maps.newHashMap();

    private static final transient double MAX_TAKEOVER_RATIO = 0.90;

    private static final transient double MIN_TAKEOVER_RATIO = 1.0 - MAX_TAKEOVER_RATIO;
