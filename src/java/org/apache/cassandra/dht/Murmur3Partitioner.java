...
public class Murmur3Partitioner implements IPartitioner {
    ...
    public static transient org.slf4j.Logger logger_IC = org.slf4j.LoggerFactory.getLogger(Murmur3Partitioner.class);

    public static transient org.slf4j.Logger logger_IC = org.slf4j.LoggerFactory.getLogger(Murmur3Partitioner.class);

    public static final transient LongToken MINIMUM = new LongToken(Long.MIN_VALUE);

    public static final transient long MAXIMUM = Long.MAX_VALUE;

    private static final transient int MAXIMUM_TOKEN_SIZE = TypeSizes.sizeof(MAXIMUM);

    private static final transient int HEAP_SIZE = (int) ObjectSizes.measureDeep(MINIMUM);

    public static final transient Murmur3Partitioner instance = new Murmur3Partitioner();
    ...
    public static class LongToken extends Token {
        ...
        static final transient long serialVersionUID = -5833580143318243006L;

        final transient long token;
