...
public class BinAuditLogger implements IAuditLogger {
    ...
    public static transient org.slf4j.Logger logger_IC = org.slf4j.LoggerFactory.getLogger(BinAuditLogger.class);

    public static transient org.slf4j.Logger logger_IC = org.slf4j.LoggerFactory.getLogger(BinAuditLogger.class);

    public static final transient long CURRENT_VERSION = 0;

    public static final transient String AUDITLOG_TYPE = "audit";

    public static final transient String AUDITLOG_MESSAGE = "message";

    private static final transient Logger logger = LoggerFactory.getLogger(BinAuditLogger.class);

    private volatile transient BinLog binLog;
