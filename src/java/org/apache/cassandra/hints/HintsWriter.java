...
class HintsWriter implements AutoCloseable {
    ...
    public static transient org.slf4j.Logger logger_IC = org.slf4j.LoggerFactory.getLogger(HintsWriter.class);

    public static transient org.slf4j.Logger logger_IC = org.slf4j.LoggerFactory.getLogger(HintsWriter.class);

    static final transient int PAGE_SIZE = 4096;
    ...
    protected final transient FileChannel channel;

    private final transient int fd;

    protected final transient CRC32 globalCRC;

    private volatile transient long lastSyncPosition = 0L;
    ...
    final class Session implements AutoCloseable {
        ...
        private final transient long initialSize;
