...
public class ParameterizedClass {
    ...
    public static transient org.slf4j.Logger logger_IC = org.slf4j.LoggerFactory.getLogger(ParameterizedClass.class);

    public static final transient String CLASS_NAME = "class_name";

    public static final transient String PARAMETERS = "parameters";

    public transient String class_name;

    public transient Map<String, String> parameters;
