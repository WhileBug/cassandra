...
public class TransparentDataEncryptionOptions {
    ...
    public static transient org.slf4j.Logger logger_IC = org.slf4j.LoggerFactory.getLogger(TransparentDataEncryptionOptions.class);

    public static transient org.slf4j.Logger logger_IC = org.slf4j.LoggerFactory.getLogger(TransparentDataEncryptionOptions.class);

    public transient boolean enabled = false;

    public transient int chunk_length_kb = 64;

    public transient String cipher = "AES/CBC/PKCS5Padding";

    public transient String key_alias;

    public transient int iv_length = 16;

    public transient ParameterizedClass key_provider;
