...
public class EncryptionOptions {
    ...
    public static transient org.slf4j.Logger logger_IC = org.slf4j.LoggerFactory.getLogger(EncryptionOptions.class);

    transient Logger logger = LoggerFactory.getLogger(EncryptionOptions.class);
    ...
    public final transient String keystore;

    public final transient String keystore_password;

    public final transient String truststore;

    public final transient String truststore_password;

    public final transient List<String> cipher_suites;

    protected transient String protocol;

    protected transient List<String> accepted_protocols;

    public final transient String algorithm;

    public final transient String store_type;

    public final transient boolean require_client_auth;

    public final transient boolean require_endpoint_verification;
    ...
    protected transient Boolean isEnabled = null;

    protected transient Boolean isOptional = null;
    ...
    public EncryptionOptions applyConfig() {
        ...
        if (optional != null) {
            isOptional = optional;
        } else // If someone is asking for an _insecure_ connection and not explicitly telling us to refuse
     ...
     */
    static private final transient List<String> TLS_PROTOCOL_SUBSTITUTION = SSLFactory.tlsInstanceProtocolSubstitution();
    ...
    public List<String> acceptedProtocols() {
        if (accepted_protocols == null) {
            if (protocol == null) {
                return null;
            } else // TLS is accepted by SSLContext.getInstance as a shorthand for give me an engine that
    ...
    public boolean equals(Object o) {
        ...
        return enabled == opt.enabled && optional == opt.optional && require_client_auth == opt.require_client_auth && require_endpoint_verification == opt.require_endpoint_verification && Objects.equals(keystore, opt.keystore) && Objects.equals(keystore_password, opt.keystore_password) && Objects.equals(truststore, opt.truststore) && Objects.equals(truststore_password, opt.truststore_password) && Objects.equals(protocol, opt.protocol) && Objects.equals(accepted_protocols, opt.accepted_protocols) && Objects.equals(algorithm, opt.algorithm) && Objects.equals(store_type, opt.store_type) && Objects.equals(cipher_suites, opt.cipher_suites);
    }
    ...
    public static class ServerEncryptionOptions extends EncryptionOptions {
        ...
        public final transient InternodeEncryption internode_encryption;

        public final transient boolean enable_legacy_ssl_storage_port;
        ...
        public boolean shouldEncrypt(InetAddressAndPort endpoint) {
            ...
            switch(internode_encryption) {
                ...
                case rack:
                    ...
                    if (snitch.getRack(endpoint).equals(snitch.getLocalRack()) && snitch.getDatacenter(endpoint).equals(snitch.getLocalDatacenter()))
                        return false;
                    break;
            }
            return true;
        ...
        public ServerEncryptionOptions withKeyStore(String keystore) {
            return new ServerEncryptionOptions(keystore, keystore_password, truststore, truststore_password, cipher_suites, protocol, accepted_protocols, algorithm, store_type, require_client_auth, require_endpoint_verification, optional, internode_encryption, enable_legacy_ssl_storage_port).applyConfigInternal();
        }
        ...
        public ServerEncryptionOptions withCipherSuites(String... cipher_suites) {
            return new ServerEncryptionOptions(keystore, keystore_password, truststore, truststore_password, ImmutableList.copyOf(cipher_suites), protocol, accepted_protocols, algorithm, store_type, require_client_auth, require_endpoint_verification, optional, internode_encryption, enable_legacy_ssl_storage_port).applyConfigInternal();
        }
        ...
        public ServerEncryptionOptions withAcceptedProtocols(List<String> accepted_protocols) {
            return new ServerEncryptionOptions(keystore, keystore_password, truststore, truststore_password, cipher_suites, protocol, accepted_protocols == null ? null : ImmutableList.copyOf(accepted_protocols), algorithm, store_type, require_client_auth, require_endpoint_verification, optional, internode_encryption, enable_legacy_ssl_storage_port).applyConfigInternal();
        }
