...
public class CassandraEntireSSTableStreamWriter {
    ...
    public static transient org.slf4j.Logger logger_IC = org.slf4j.LoggerFactory.getLogger(CassandraEntireSSTableStreamWriter.class);

    private static final transient Logger logger = LoggerFactory.getLogger(CassandraEntireSSTableStreamWriter.class);

    private final transient SSTableReader sstable;

    private final transient ComponentContext context;

    private final transient ComponentManifest manifest;

    private final transient StreamSession session;

    private final transient StreamRateLimiter limiter;
