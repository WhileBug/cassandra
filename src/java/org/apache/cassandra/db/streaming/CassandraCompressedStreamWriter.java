...
public class CassandraCompressedStreamWriter extends CassandraStreamWriter {
    ...
    public static transient org.slf4j.Logger logger_IC = org.slf4j.LoggerFactory.getLogger(CassandraCompressedStreamWriter.class);

    public static transient org.slf4j.Logger logger_IC = org.slf4j.LoggerFactory.getLogger(CassandraCompressedStreamWriter.class);

    private static final transient int CHUNK_SIZE = 1 << 16;

    private static final transient int CRC_LENGTH = 4;

    private static final transient Logger logger = LoggerFactory.getLogger(CassandraCompressedStreamWriter.class);

    private final transient CompressionInfo compressionInfo;
