...
public abstract class CompressionInfo {
    ...
    public static transient org.slf4j.Logger logger_IC = org.slf4j.LoggerFactory.getLogger(CompressionInfo.class);

    public static final transient IVersionedSerializer<CompressionInfo> serializer = new CompressionInfoSerializer();
    ...
    public boolean equals(Object o) {
        ...
        return Objects.equals(parameters(), that.parameters()) && Arrays.equals(chunks(), that.chunks());
    }
    ...
    static class CompressionInfoSerializer implements IVersionedSerializer<CompressionInfo> {
        ...
        public void serialize(CompressionInfo info, DataOutputPlus out, int version) throws IOException {
            ...
            for (int i = 0; i < chunkCount; i++) CompressionMetadata.Chunk.serializer.serialize(chunks[i], out, version);
            // compression params
        ...
        public long serializedSize(CompressionInfo info, int version) {
            ...
            for (int i = 0; i < chunkCount; i++) size += CompressionMetadata.Chunk.serializer.serializedSize(chunks[i], version);
            // compression params
