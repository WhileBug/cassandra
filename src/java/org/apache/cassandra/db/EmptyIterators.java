...
public class EmptyIterators {
    ...
    public static transient org.slf4j.Logger logger_IC = org.slf4j.LoggerFactory.getLogger(EmptyIterators.class);
    ...
    private static class EmptyPartitionIterator extends EmptyBasePartitionIterator<RowIterator> implements PartitionIterator {
        ...
        public static final transient EmptyPartitionIterator instance = new EmptyPartitionIterator();
    ...
    private static class EmptyBaseRowIterator<U extends Unfiltered> implements BaseRowIterator<U> {
        ...
        final transient RegularAndStaticColumns columns;

        final transient TableMetadata metadata;

        final transient DecoratedKey partitionKey;

        final transient boolean isReverseOrder;
