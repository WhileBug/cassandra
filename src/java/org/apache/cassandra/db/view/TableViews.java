...
public class TableViews extends AbstractCollection<View> {
    ...
    public static transient org.slf4j.Logger logger_IC = org.slf4j.LoggerFactory.getLogger(TableViews.class);

    private final transient TableMetadataRef baseTableMetadata;
    ...
    private final transient List<View> views = new CopyOnWriteArrayList();
    ...
    private static class DeletionTracker {
        ...
        private transient DeletionTime deletion;
