...
public class ViewBuilderTask extends CompactionInfo.Holder implements Callable<Long> {
    ...
    public static transient org.slf4j.Logger logger_IC = org.slf4j.LoggerFactory.getLogger(ViewBuilderTask.class);

    private static final transient Logger logger = LoggerFactory.getLogger(ViewBuilderTask.class);

    private static final transient int ROWS_BETWEEN_CHECKPOINTS = 1000;
    ...
    private volatile transient Token prevToken;

    private volatile transient long keysBuilt = 0;

    private volatile transient boolean isStopped = false;

    private volatile transient boolean isCompactionInterrupted = false;
    ...
    static class StoppedException extends CompactionInterruptedException {
        ...
        private final transient String ksName, viewName;
