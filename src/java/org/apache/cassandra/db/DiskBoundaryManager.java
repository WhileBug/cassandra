...
public class DiskBoundaryManager {
    ...
    public static transient org.slf4j.Logger logger_IC = org.slf4j.LoggerFactory.getLogger(DiskBoundaryManager.class);

    public static transient org.slf4j.Logger logger_IC = org.slf4j.LoggerFactory.getLogger(DiskBoundaryManager.class);

    private static final transient Logger logger = LoggerFactory.getLogger(DiskBoundaryManager.class);

    private volatile transient DiskBoundaries diskBoundaries;
    ...
    private static DiskBoundaries getDiskBoundaryValue(ColumnFamilyStore cfs) {
        ...
        do {
            ...
            if (// When replacing same address, the node marks itself as UN locally
            StorageService.instance.isBootstrapMode() && !StorageService.isReplacingSameAddress()) {
