...
public class CounterMutationVerbHandler implements IVerbHandler<CounterMutation> {
    ...
    public static transient org.slf4j.Logger logger_IC = org.slf4j.LoggerFactory.getLogger(CounterMutationVerbHandler.class);

    public static final transient CounterMutationVerbHandler instance = new CounterMutationVerbHandler();

    private static final transient Logger logger = LoggerFactory.getLogger(CounterMutationVerbHandler.class);
