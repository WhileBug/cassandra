...
public abstract class PurgeFunction extends Transformation<UnfilteredRowIterator> {
    ...
    public static transient org.slf4j.Logger logger_IC = org.slf4j.LoggerFactory.getLogger(PurgeFunction.class);

    private final transient DeletionPurger purger;

    private final transient int nowInSec;

    private final transient boolean enforceStrictLiveness;

    private transient boolean isReverseOrder;
