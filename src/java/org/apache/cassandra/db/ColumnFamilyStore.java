...
public class ColumnFamilyStore implements ColumnFamilyStoreMBean {
    ...
    */
    ...
    Descriptor getUniqueDescriptorFor(Descriptor descriptor, File targetDirectory) {
        ...
        do {
            newDescriptor = new Descriptor(descriptor.version, targetDirectory, descriptor.ksname, descriptor.cfname, // Increment the generation until we find a filename that doesn't exist. This is needed because the new
