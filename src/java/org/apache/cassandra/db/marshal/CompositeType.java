...
public class CompositeType extends AbstractCompositeType {
    ...
    public static transient org.slf4j.Logger logger_IC = org.slf4j.LoggerFactory.getLogger(CompositeType.class);

    public static transient org.slf4j.Logger logger_IC = org.slf4j.LoggerFactory.getLogger(CompositeType.class);

    private static final transient int STATIC_MARKER = 0xFFFF;

    public final transient List<AbstractType<?>> types;

    // interning instances
    private static final transient ConcurrentMap<List<AbstractType<?>>, CompositeType> instances = new ConcurrentHashMap<>();
