...
public class ReversedType<T> extends AbstractType<T> {
    ...
    public static transient org.slf4j.Logger logger_IC = org.slf4j.LoggerFactory.getLogger(ReversedType.class);

    public static transient org.slf4j.Logger logger_IC = org.slf4j.LoggerFactory.getLogger(ReversedType.class);

    // interning instances
    private static final transient Map<AbstractType<?>, ReversedType> instances = new ConcurrentHashMap<>();

    public final transient AbstractType<T> baseType;
