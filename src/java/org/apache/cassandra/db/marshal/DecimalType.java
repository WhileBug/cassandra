...
public class DecimalType extends NumberType<BigDecimal> {
    ...
    public static transient org.slf4j.Logger logger_IC = org.slf4j.LoggerFactory.getLogger(DecimalType.class);

    public static transient org.slf4j.Logger logger_IC = org.slf4j.LoggerFactory.getLogger(DecimalType.class);

    public static final transient DecimalType instance = new DecimalType();

    private static final transient int MIN_SCALE = 32;

    private static final transient int MIN_SIGNIFICANT_DIGITS = MIN_SCALE;

    private static final transient int MAX_SCALE = 1000;

    private static final transient MathContext MAX_PRECISION = new MathContext(10000);
