...
public class ByteBufferAccessor implements ValueAccessor<ByteBuffer> {
    ...
    public static transient org.slf4j.Logger logger_IC = org.slf4j.LoggerFactory.getLogger(ByteBufferAccessor.class);

    public static final transient ValueAccessor<ByteBuffer> instance = new ByteBufferAccessor();
