...
public class TimeType extends TemporalType<Long> {
    ...
    public static transient org.slf4j.Logger logger_IC = org.slf4j.LoggerFactory.getLogger(TimeType.class);

    public static final transient TimeType instance = new TimeType();
