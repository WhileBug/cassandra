...
public class ByteType extends NumberType<Byte> {
    ...
    public static transient org.slf4j.Logger logger_IC = org.slf4j.LoggerFactory.getLogger(ByteType.class);

    public static transient org.slf4j.Logger logger_IC = org.slf4j.LoggerFactory.getLogger(ByteType.class);

    public static final transient ByteType instance = new ByteType();
