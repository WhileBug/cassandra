...
public class ShortType extends NumberType<Short> {
    ...
    public static transient org.slf4j.Logger logger_IC = org.slf4j.LoggerFactory.getLogger(ShortType.class);

    public static final transient ShortType instance = new ShortType();
