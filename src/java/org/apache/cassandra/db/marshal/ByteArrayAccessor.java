...
public class ByteArrayAccessor implements ValueAccessor<byte[]> {
    ...
    public static transient org.slf4j.Logger logger_IC = org.slf4j.LoggerFactory.getLogger(ByteArrayAccessor.class);

    public static transient org.slf4j.Logger logger_IC = org.slf4j.LoggerFactory.getLogger(ByteArrayAccessor.class);

    public static final transient ValueAccessor<byte[]> instance = new ByteArrayAccessor();

    public static final transient ObjectFactory<byte[]> factory = ByteArrayObjectFactory.instance;

    private static final transient byte[] EMPTY = new byte[0];
