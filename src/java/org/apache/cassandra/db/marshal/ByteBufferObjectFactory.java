...
class ByteBufferObjectFactory implements ValueAccessor.ObjectFactory<ByteBuffer> {
    ...
    public static transient org.slf4j.Logger logger_IC = org.slf4j.LoggerFactory.getLogger(ByteBufferObjectFactory.class);

    /**
     * Empty clustering for tables having no clustering columns.
     */
    private static final transient Clustering<ByteBuffer> EMPTY_CLUSTERING = new BufferClustering() {
     ...
     */
    private static final transient BufferClusteringBound BOTTOM_BOUND = new BufferClusteringBound(ClusteringPrefix.Kind.INCL_START_BOUND, new ByteBuffer[0]);

    /**
     * The biggest end bound, i.e. the one that ends after any row.
     */
    private static final transient BufferClusteringBound TOP_BOUND = new BufferClusteringBound(ClusteringPrefix.Kind.INCL_END_BOUND, new ByteBuffer[0]);

    static final transient ValueAccessor.ObjectFactory<ByteBuffer> instance = new ByteBufferObjectFactory();
