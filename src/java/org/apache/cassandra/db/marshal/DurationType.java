...
public class DurationType extends AbstractType<Duration> {
    ...
    public static transient org.slf4j.Logger logger_IC = org.slf4j.LoggerFactory.getLogger(DurationType.class);

    public static transient org.slf4j.Logger logger_IC = org.slf4j.LoggerFactory.getLogger(DurationType.class);

    public static final transient DurationType instance = new DurationType();
    ...
    public Term fromJSONObject(Object parsed) throws MarshalException {
        try {
            ...
            throw new MarshalException(String.format("Expected a string representation of a duration, but got a %s: %s", parsed.getClass().getSimpleName(), parsed));
        }
    }
