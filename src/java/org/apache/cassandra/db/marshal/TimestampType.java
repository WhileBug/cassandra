...
public class TimestampType extends TemporalType<Date> {
    ...
    public static transient org.slf4j.Logger logger_IC = org.slf4j.LoggerFactory.getLogger(TimestampType.class);

    private static final transient Logger logger = LoggerFactory.getLogger(TimestampType.class);

    public static final transient TimestampType instance = new TimestampType();
