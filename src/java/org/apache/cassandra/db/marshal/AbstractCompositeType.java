...
public abstract class AbstractCompositeType extends AbstractType<ByteBuffer> {
    ...
    public static transient org.slf4j.Logger logger_IC = org.slf4j.LoggerFactory.getLogger(AbstractCompositeType.class);
    ...
    public ByteBuffer fromString(String source) {
        ...
        for (ByteBuffer component : components) {
            ...
            // it's not ok to consume component as we did not create it (CASSANDRA-14752)
