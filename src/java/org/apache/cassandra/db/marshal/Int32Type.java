...
public class Int32Type extends NumberType<Integer> {
    ...
    public static transient org.slf4j.Logger logger_IC = org.slf4j.LoggerFactory.getLogger(Int32Type.class);

    public static final transient Int32Type instance = new Int32Type();
