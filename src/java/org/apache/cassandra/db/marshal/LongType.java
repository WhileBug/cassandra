...
public class LongType extends NumberType<Long> {
    ...
    public static transient org.slf4j.Logger logger_IC = org.slf4j.LoggerFactory.getLogger(LongType.class);

    public static final transient LongType instance = new LongType();
