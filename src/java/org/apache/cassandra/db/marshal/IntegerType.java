...
public final class IntegerType extends NumberType<BigInteger> {
    ...
    public static transient org.slf4j.Logger logger_IC = org.slf4j.LoggerFactory.getLogger(IntegerType.class);

    public static transient org.slf4j.Logger logger_IC = org.slf4j.LoggerFactory.getLogger(IntegerType.class);

    public static final transient IntegerType instance = new IntegerType();
