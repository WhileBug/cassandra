...
public class EmptyType extends AbstractType<Void> {
    ...
    public static transient org.slf4j.Logger logger_IC = org.slf4j.LoggerFactory.getLogger(EmptyType.class);

    public static transient org.slf4j.Logger logger_IC = org.slf4j.LoggerFactory.getLogger(EmptyType.class);

    private enum NonEmptyWriteBehavior {

        FAIL, LOG_DATA_LOSS, SILENT_DATA_LOSS
    }

    private static final transient Logger logger = LoggerFactory.getLogger(EmptyType.class);

    private static final transient String KEY_EMPTYTYPE_NONEMPTY_BEHAVIOR = "cassandra.serialization.emptytype.nonempty_behavior";

    private static final transient NoSpamLogger NON_EMPTY_WRITE_LOGGER = NoSpamLogger.getLogger(logger, 1, TimeUnit.MINUTES);

    private static final transient NonEmptyWriteBehavior NON_EMPTY_WRITE_BEHAVIOR = parseNonEmptyWriteBehavior();
    ...
    public static final transient EmptyType instance = new EmptyType();
