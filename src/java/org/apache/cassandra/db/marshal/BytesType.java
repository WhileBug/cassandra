...
public class BytesType extends AbstractType<ByteBuffer> {
    ...
    public static transient org.slf4j.Logger logger_IC = org.slf4j.LoggerFactory.getLogger(BytesType.class);

    public static transient org.slf4j.Logger logger_IC = org.slf4j.LoggerFactory.getLogger(BytesType.class);

    public static final transient BytesType instance = new BytesType();
