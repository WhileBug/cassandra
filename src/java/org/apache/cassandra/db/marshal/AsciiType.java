...
public class AsciiType extends AbstractType<String> {
    ...
    public static transient org.slf4j.Logger logger_IC = org.slf4j.LoggerFactory.getLogger(AsciiType.class);

    public static transient org.slf4j.Logger logger_IC = org.slf4j.LoggerFactory.getLogger(AsciiType.class);

    public static final transient AsciiType instance = new AsciiType();
    ...
    private final transient FastThreadLocal<CharsetEncoder> encoder = new FastThreadLocal<CharsetEncoder>() {
