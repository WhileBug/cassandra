...
public class ClusteringIndexSliceFilter extends AbstractClusteringIndexFilter {
    ...
    public static transient org.slf4j.Logger logger_IC = org.slf4j.LoggerFactory.getLogger(ClusteringIndexSliceFilter.class);

    static final transient InternalDeserializer deserializer = new SliceDeserializer();
