...
public class UnfilteredValidation {
    ...
    public static transient org.slf4j.Logger logger_IC = org.slf4j.LoggerFactory.getLogger(UnfilteredValidation.class);

    public static transient org.slf4j.Logger logger_IC = org.slf4j.LoggerFactory.getLogger(UnfilteredValidation.class);

    private static final transient Logger logger = LoggerFactory.getLogger(UnfilteredValidation.class);
    ...
    public static void maybeValidateUnfiltered(Unfiltered unfiltered, TableMetadata metadata, DecoratedKey key, SSTableReader sstable) {
        ...
        if (strat != Config.CorruptedTombstoneStrategy.disabled && unfiltered != null && !unfiltered.isEmpty()) {
            ...
            } catch (// make sure no unknown exceptions fail the read/compaction
            Throwable t) {
