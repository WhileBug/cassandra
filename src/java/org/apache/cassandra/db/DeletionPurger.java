...
public interface DeletionPurger {
    ...
    public static transient org.slf4j.Logger logger_IC = org.slf4j.LoggerFactory.getLogger(DeletionPurger.class);

    public static final transient DeletionPurger PURGE_ALL = (ts, ldt) -> true;
