...
public final class SizeTieredCompactionStrategyOptions {
    ...
    public static transient org.slf4j.Logger logger_IC = org.slf4j.LoggerFactory.getLogger(SizeTieredCompactionStrategyOptions.class);

    public static transient org.slf4j.Logger logger_IC = org.slf4j.LoggerFactory.getLogger(SizeTieredCompactionStrategyOptions.class);

    protected static final transient long DEFAULT_MIN_SSTABLE_SIZE = 50L * 1024L * 1024L;

    protected static final transient double DEFAULT_BUCKET_LOW = 0.5;

    protected static final transient double DEFAULT_BUCKET_HIGH = 1.5;

    protected static final transient String MIN_SSTABLE_SIZE_KEY = "min_sstable_size";

    protected static final transient String BUCKET_LOW_KEY = "bucket_low";

    protected static final transient String BUCKET_HIGH_KEY = "bucket_high";

    protected transient long minSSTableSize;

    protected transient double bucketLow;

    protected transient double bucketHigh;
