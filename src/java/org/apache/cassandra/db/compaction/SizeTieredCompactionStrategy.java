...
public class SizeTieredCompactionStrategy extends AbstractCompactionStrategy {
    ...
    public static transient org.slf4j.Logger logger_IC = org.slf4j.LoggerFactory.getLogger(SizeTieredCompactionStrategy.class);

    private static final transient Logger logger = LoggerFactory.getLogger(SizeTieredCompactionStrategy.class);

    private static final transient Comparator<Pair<List<SSTableReader>, Double>> bucketsByHotnessComparator = new Comparator<Pair<List<SSTableReader>, Double>>() {
    ...
    protected transient SizeTieredCompactionStrategyOptions sizeTieredOptions;

    protected volatile transient int estimatedRemainingTasks;

    @VisibleForTesting
    protected final transient Set<SSTableReader> sstables = new HashSet<>();
    ...
    public String toString() {
        return String.format("SizeTieredCompactionStrategy[%s/%s]", cfs.getMinimumCompactionThreshold(), cfs.getMaximumCompactionThreshold());
    }
