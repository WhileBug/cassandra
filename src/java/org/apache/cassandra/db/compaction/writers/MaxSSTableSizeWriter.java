...
public class MaxSSTableSizeWriter extends CompactionAwareWriter {
    ...
    public static transient org.slf4j.Logger logger_IC = org.slf4j.LoggerFactory.getLogger(MaxSSTableSizeWriter.class);

    private final transient long maxSSTableSize;

    private final transient int level;

    private final transient long estimatedSSTables;
