...
public class LeveledManifest {
    ...
    public static transient org.slf4j.Logger logger_IC = org.slf4j.LoggerFactory.getLogger(LeveledManifest.class);

    public static transient org.slf4j.Logger logger_IC = org.slf4j.LoggerFactory.getLogger(LeveledManifest.class);

    private static final transient Logger logger = LoggerFactory.getLogger(LeveledManifest.class);
     ...
     */
    private static final transient int MAX_COMPACTING_L0 = 32;
     ...
     */
    private static final transient int NO_COMPACTION_LIMIT = 25;

    private final transient ColumnFamilyStore cfs;

    private final transient LeveledGenerations generations;

    private final transient SSTableReader[] lastCompactedSSTables;

    private final transient long maxSSTableSizeInBytes;

    private final transient SizeTieredCompactionStrategyOptions options;

    private final transient int[] compactionCounter;
    ...
    public synchronized CompactionCandidate getCompactionCandidates() {
        ...
        for (int i = generations.levelCount() - 1; i > 0; i--) {
            ...
            if (sstables.isEmpty())
                // mostly this just avoids polluting the debug log with zero scores
                continue;
    ...
    public static class CompactionCandidate {
        ...
        public final transient long maxSSTableBytes;
