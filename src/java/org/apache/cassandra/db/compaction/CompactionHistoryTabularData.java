...
public class CompactionHistoryTabularData {
    ...
    public static transient org.slf4j.Logger logger_IC = org.slf4j.LoggerFactory.getLogger(CompactionHistoryTabularData.class);

    private static final transient String[] ITEM_NAMES = new String[] { "id", "keyspace_name", "columnfamily_name", "compacted_at", "bytes_in", "bytes_out", "rows_merged" };

    private static final transient String[] ITEM_DESCS = new String[] { "time uuid", "keyspace name", "column family name", "compaction finished at", "total bytes in", "total bytes out", "total rows merged" };

    private static final transient String TYPE_NAME = "CompactionHistory";

    private static final transient String ROW_DESC = "CompactionHistory";

    private static final transient OpenType<?>[] ITEM_TYPES;

    private static final transient CompositeType COMPOSITE_TYPE;

    private static final transient TabularType TABULAR_TYPE;
