...
public class TimeWindowCompactionStrategy extends AbstractCompactionStrategy {
    ...
    public static transient org.slf4j.Logger logger_IC = org.slf4j.LoggerFactory.getLogger(TimeWindowCompactionStrategy.class);

    private static final transient Logger logger = LoggerFactory.getLogger(TimeWindowCompactionStrategy.class);

    private final transient TimeWindowCompactionStrategyOptions options;
    ...
    private transient long highestWindowSeen;
    ...
    static final class NewestBucket {
         ...
         */
        final transient List<SSTableReader> sstables;

        /**
         * The number of tasks estimated
         */
        final transient int estimatedRemainingTasks;
