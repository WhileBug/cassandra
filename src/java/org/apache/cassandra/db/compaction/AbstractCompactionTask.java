...
public abstract class AbstractCompactionTask extends WrappedRunnable {
    ...
    public static transient org.slf4j.Logger logger_IC = org.slf4j.LoggerFactory.getLogger(AbstractCompactionTask.class);

    public static transient org.slf4j.Logger logger_IC = org.slf4j.LoggerFactory.getLogger(AbstractCompactionTask.class);

    protected final transient ColumnFamilyStore cfs;

    protected transient LifecycleTransaction transaction;

    protected transient boolean isUserDefined;

    protected transient OperationType compactionType;
