...
public class Digest {
    ...
    public static transient org.slf4j.Logger logger_IC = org.slf4j.LoggerFactory.getLogger(Digest.class);

    private static final transient ThreadLocal<byte[]> localBuffer = ThreadLocal.withInitial(() -> new byte[4096]);

    private final transient Hasher hasher;

    private transient long inputBytes = 0;
