...
public class SnapshotDetailsTabularData {
    ...
    public static transient org.slf4j.Logger logger_IC = org.slf4j.LoggerFactory.getLogger(SnapshotDetailsTabularData.class);

    public static transient org.slf4j.Logger logger_IC = org.slf4j.LoggerFactory.getLogger(SnapshotDetailsTabularData.class);

    private static final transient String[] ITEM_NAMES = new String[] { "Snapshot name", "Keyspace name", "Column family name", "True size", "Size on disk" };

    private static final transient String[] ITEM_DESCS = new String[] { "snapshot_name", "keyspace_name", "columnfamily_name", "TrueDiskSpaceUsed", "TotalDiskSpaceUsed" };

    private static final transient String TYPE_NAME = "SnapshotDetails";

    private static final transient String ROW_DESC = "SnapshotDetails";

    private static final transient OpenType<?>[] ITEM_TYPES;

    private static final transient CompositeType COMPOSITE_TYPE;

    public static final transient TabularType TABULAR_TYPE;
