...
public class ExpirationDateOverflowHandling {
    ...
    public static transient org.slf4j.Logger logger_IC = org.slf4j.LoggerFactory.getLogger(ExpirationDateOverflowHandling.class);

    private static final transient Logger logger = LoggerFactory.getLogger(ExpirationDateOverflowHandling.class);

    private static final transient int EXPIRATION_OVERFLOW_WARNING_INTERVAL_MINUTES = Integer.getInteger("cassandra.expiration_overflow_warning_interval_minutes", 5);
    ...
    @VisibleForTesting
    public static transient ExpirationDateOverflowPolicy policy;
