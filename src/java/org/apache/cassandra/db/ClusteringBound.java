...
public interface ClusteringBound<V> extends ClusteringBoundOrBoundary<V> {
    ...
    public static transient org.slf4j.Logger logger_IC = org.slf4j.LoggerFactory.getLogger(ClusteringBound.class);

    /**
     * The smallest start bound, i.e. the one that starts before any row.
     */
    public static final transient ClusteringBound<?> BOTTOM = new BufferClusteringBound(ClusteringPrefix.Kind.INCL_START_BOUND, BufferClusteringBound.EMPTY_VALUES_ARRAY);

    /**
     * The biggest end bound, i.e. the one that ends after any row.
     */
    public static final transient ClusteringBound<?> TOP = new BufferClusteringBound(ClusteringPrefix.Kind.INCL_END_BOUND, BufferClusteringBound.EMPTY_VALUES_ARRAY);
