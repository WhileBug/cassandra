...
public final class SystemKeyspace {
    ...
    private static final transient TableMetadata BuiltIndexes = parse(BUILT_INDEXES, "built column indexes", "CREATE TABLE \"%s\" (" + // table_name here is the name of the keyspace - don't be fooled
    "table_name text," + "index_name text," + // Table used to be compact in previous versions
    "value blob," + "PRIMARY KEY ((table_name), index_name)) ").build();
