...
public abstract class AbstractCommitLogService {
    ...
    public static transient org.slf4j.Logger logger_IC = org.slf4j.LoggerFactory.getLogger(AbstractCommitLogService.class);
     ...
     */
    static final transient long DEFAULT_MARKER_INTERVAL_MILLIS = 100;
    ...
    protected volatile transient long lastSyncedAt = System.currentTimeMillis();

    // counts of total written, and pending, log messages
    private final transient AtomicLong written = new AtomicLong(0);

    protected final transient AtomicLong pending = new AtomicLong(0);

    // signal that writers can wait on to be notified of a completed sync
    protected final transient WaitQueue syncComplete = new WaitQueue();

    final transient CommitLog commitLog;
     ...
     */
    final transient long syncIntervalNanos;
     ...
     */
    final transient long markerIntervalNanos;
     ...
     */
    private volatile transient boolean syncRequested;

    private static final transient Logger logger = LoggerFactory.getLogger(AbstractCommitLogService.class);
    ...
    class SyncRunnable implements Runnable {
        ...
        private transient long firstLagAt = 0;

        // total time spent syncing since firstLagAt
        private transient long totalSyncDuration = 0;

        // time that syncs exceeded pollInterval since firstLagAt
        private transient long syncExceededIntervalBy = 0;

        private transient int lagCount = 0;

        private transient int syncCount = 0;
