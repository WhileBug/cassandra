...
public class EncryptedSegment extends FileDirectSegment {
    ...
    public static transient org.slf4j.Logger logger_IC = org.slf4j.LoggerFactory.getLogger(EncryptedSegment.class);

    public static transient org.slf4j.Logger logger_IC = org.slf4j.LoggerFactory.getLogger(EncryptedSegment.class);

    private static final transient Logger logger = LoggerFactory.getLogger(EncryptedSegment.class);

    private static final transient int ENCRYPTED_SECTION_HEADER_SIZE = SYNC_MARKER_SIZE + 4;
