...
public class IntervalSet<T extends Comparable<T>> {
    ...
    public static transient org.slf4j.Logger logger_IC = org.slf4j.LoggerFactory.getLogger(IntervalSet.class);

    @SuppressWarnings({ "rawtypes", "unchecked" })
    private static final transient IntervalSet EMPTY = new IntervalSet(ImmutableSortedMap.of());

    final private transient NavigableMap<T, T> ranges;
    ...
    static public class Builder<T extends Comparable<T>> {
        ...
        final transient NavigableMap<T, T> ranges;
