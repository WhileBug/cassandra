...
public class CommitLogSegmentReader implements Iterable<CommitLogSegmentReader.SyncSegment> {
    ...
    public static transient org.slf4j.Logger logger_IC = org.slf4j.LoggerFactory.getLogger(CommitLogSegmentReader.class);

    private final transient CommitLogReadHandler handler;

    private final transient CommitLogDescriptor descriptor;

    private final transient RandomAccessReader reader;

    private final transient Segmenter segmenter;

    private final transient boolean tolerateTruncation;
    ...
    public static class SegmentReadException extends IOException {
        ...
        public final transient boolean invalidCrc;
    ...
    public static class SyncSegment {
         ...
         */
        public final transient FileDataInput input;

        /**
         * offset in file where this section begins.
         */
        public final transient int fileStartPosition;

        /**
         * offset in file where this section ends.
         */
        public final transient int fileEndPosition;

        /**
         * the logical ending position of the buffer
         */
        public final transient int endPosition;

        public final transient boolean toleratesErrorsInSection;
    ...
    static class CompressedSegmenter implements Segmenter {
        ...
        private transient byte[] uncompressedBuffer;

        private transient long nextLogicalStart;
    ...
    static class EncryptedSegmenter implements Segmenter {
         ...
         */
        private transient ByteBuffer decryptedBuffer;
        ...
        private final transient ChunkProvider chunkProvider;

        private transient long currentSegmentEndPosition;
