...
public abstract class RowIterators {
    ...
    public static transient org.slf4j.Logger logger_IC = org.slf4j.LoggerFactory.getLogger(RowIterators.class);

    public static transient org.slf4j.Logger logger_IC = org.slf4j.LoggerFactory.getLogger(RowIterators.class);

    private static final transient Logger logger = LoggerFactory.getLogger(RowIterators.class);
