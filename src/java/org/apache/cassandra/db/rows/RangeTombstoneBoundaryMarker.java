...
public class RangeTombstoneBoundaryMarker extends AbstractRangeTombstoneMarker<ClusteringBoundary<?>> {
    ...
    public static transient org.slf4j.Logger logger_IC = org.slf4j.LoggerFactory.getLogger(RangeTombstoneBoundaryMarker.class);

    private final transient DeletionTime endDeletion;

    private final transient DeletionTime startDeletion;
    ...
    public String toString(TableMetadata metadata) {
        return String.format("Marker %s@%d/%d-%d/%d", bound.toString(metadata), endDeletion.markedForDeleteAt(), endDeletion.localDeletionTime(), startDeletion.markedForDeleteAt(), startDeletion.localDeletionTime());
    }
