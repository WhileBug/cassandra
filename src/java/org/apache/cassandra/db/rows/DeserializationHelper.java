...
public class DeserializationHelper {
    ...
    public static transient org.slf4j.Logger logger_IC = org.slf4j.LoggerFactory.getLogger(DeserializationHelper.class);
    ...
    private final transient Flag flag;

    public final transient int version;

    private final transient ColumnFilter columnsToFetch;

    private transient ColumnFilter.Tester tester;

    private final transient boolean hasDroppedColumns;

    private final transient Map<ByteBuffer, DroppedColumn> droppedColumns;

    private transient DroppedColumn currentDroppedComplex;
