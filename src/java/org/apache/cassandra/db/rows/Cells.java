...
public abstract class Cells {
    ...
    public static transient org.slf4j.Logger logger_IC = org.slf4j.LoggerFactory.getLogger(Cells.class);
    ...
    private static Cell<?> resolveRegular(Cell<?> left, Cell<?> right) {
        ...
        if (leftIsExpiringOrTombstone | rightIsExpiringOrTombstone) {
            ...
            // !isExpiring() == isTombstone(), but does not need to consider localDeletionTime()
