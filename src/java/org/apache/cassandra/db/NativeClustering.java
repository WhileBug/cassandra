...
public class NativeClustering implements Clustering<ByteBuffer> {
    ...
    public static transient org.slf4j.Logger logger_IC = org.slf4j.LoggerFactory.getLogger(NativeClustering.class);

    private static final transient long EMPTY_SIZE = ObjectSizes.measure(new NativeClustering());
    ...
    public ByteBuffer get(int i) {
        ...
        return MemoryUtil.getByteBuffer(bitmapStart + bitmapSize + startOffset, endOffset - startOffset, ByteOrder.BIG_ENDIAN);
    }
