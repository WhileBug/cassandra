...
public class ReadCommandVerbHandler implements IVerbHandler<ReadCommand> {
    ...
    public static transient org.slf4j.Logger logger_IC = org.slf4j.LoggerFactory.getLogger(ReadCommandVerbHandler.class);

    public static final transient ReadCommandVerbHandler instance = new ReadCommandVerbHandler();

    private static final transient Logger logger = LoggerFactory.getLogger(ReadCommandVerbHandler.class);
