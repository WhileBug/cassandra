...
public interface Clustering<V> extends ClusteringPrefix<V> {
     ...
     */
    public static final transient Clustering<ByteBuffer> STATIC_CLUSTERING = new BufferClustering(EMPTY_VALUES_ARRAY) {
     ...
     */
    public static final transient Clustering<ByteBuffer> EMPTY = new BufferClustering(EMPTY_VALUES_ARRAY) {
