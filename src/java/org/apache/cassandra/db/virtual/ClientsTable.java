...
final class ClientsTable extends AbstractVirtualTable {
    ...
    public static transient org.slf4j.Logger logger_IC = org.slf4j.LoggerFactory.getLogger(ClientsTable.class);
    ...
    private static final transient String HOSTNAME = "hostname";

    private static final transient String USERNAME = "username";

    private static final transient String CONNECTION_STAGE = "connection_stage";

    private static final transient String PROTOCOL_VERSION = "protocol_version";

    private static final transient String DRIVER_NAME = "driver_name";

    private static final transient String DRIVER_VERSION = "driver_version";

    private static final transient String REQUEST_COUNT = "request_count";

    private static final transient String SSL_ENABLED = "ssl_enabled";

    private static final transient String SSL_PROTOCOL = "ssl_protocol";

    private static final transient String SSL_CIPHER_SUITE = "ssl_cipher_suite";
