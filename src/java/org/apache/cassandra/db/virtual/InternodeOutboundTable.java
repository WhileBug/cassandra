...
public final class InternodeOutboundTable extends AbstractVirtualTable {
    ...
    public static transient org.slf4j.Logger logger_IC = org.slf4j.LoggerFactory.getLogger(InternodeOutboundTable.class);
    ...
    private static final transient String PENDING_COUNT = "pending_count";

    private static final transient String PENDING_BYTES = "pending_bytes";

    private static final transient String SENT_COUNT = "sent_count";

    private static final transient String SENT_BYTES = "sent_bytes";
    ...
    private static final transient String OVERLOAD_COUNT = "overload_count";

    private static final transient String OVERLOAD_BYTES = "overload_bytes";

    private static final transient String ACTIVE_CONNECTION_COUNT = "active_connections";

    private static final transient String CONNECTION_ATTEMPTS = "connection_attempts";

    private static final transient String SUCCESSFUL_CONNECTION_ATTEMPTS = "successful_connection_attempts";
    ...
    public DataSet data() {
        SimpleDataSet result = new SimpleDataSet(metadata());
        MessagingService.instance().channelManagers.forEach((addressAndPort, connections) -> addRow(result, addressAndPort, connections));
        return result;
    }
