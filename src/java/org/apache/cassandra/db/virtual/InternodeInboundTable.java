...
public final class InternodeInboundTable extends AbstractVirtualTable {
    ...
    public static transient org.slf4j.Logger logger_IC = org.slf4j.LoggerFactory.getLogger(InternodeInboundTable.class);

    public static transient org.slf4j.Logger logger_IC = org.slf4j.LoggerFactory.getLogger(InternodeInboundTable.class);

    private static final transient String ADDRESS = "address";

    private static final transient String PORT = "port";

    private static final transient String DC = "dc";

    private static final transient String RACK = "rack";

    private static final transient String USING_BYTES = "using_bytes";

    private static final transient String USING_RESERVE_BYTES = "using_reserve_bytes";

    private static final transient String CORRUPT_FRAMES_RECOVERED = "corrupt_frames_recovered";

    private static final transient String CORRUPT_FRAMES_UNRECOVERED = "corrupt_frames_unrecovered";

    private static final transient String ERROR_BYTES = "error_bytes";

    private static final transient String ERROR_COUNT = "error_count";

    private static final transient String EXPIRED_BYTES = "expired_bytes";

    private static final transient String EXPIRED_COUNT = "expired_count";

    private static final transient String SCHEDULED_BYTES = "scheduled_bytes";

    private static final transient String SCHEDULED_COUNT = "scheduled_count";

    private static final transient String PROCESSED_BYTES = "processed_bytes";

    private static final transient String PROCESSED_COUNT = "processed_count";

    private static final transient String RECEIVED_BYTES = "received_bytes";

    private static final transient String RECEIVED_COUNT = "received_count";

    private static final transient String THROTTLED_COUNT = "throttled_count";

    private static final transient String THROTTLED_NANOS = "throttled_nanos";
    ...
    public DataSet data() {
        SimpleDataSet result = new SimpleDataSet(metadata());
        MessagingService.instance().messageHandlers.forEach((addressAndPort, handlers) -> addRow(result, addressAndPort, handlers));
        return result;
    }
