...
public class EncryptionContext {
    ...
    public static transient org.slf4j.Logger logger_IC = org.slf4j.LoggerFactory.getLogger(EncryptionContext.class);

    public static final transient String ENCRYPTION_CIPHER = "encCipher";

    public static final transient String ENCRYPTION_KEY_ALIAS = "encKeyAlias";

    public static final transient String ENCRYPTION_IV = "encIV";

    private final transient TransparentDataEncryptionOptions tdeOptions;

    private final transient ICompressor compressor;

    private final transient CipherFactory cipherFactory;

    private final transient byte[] iv;
    ...
    public boolean equals(EncryptionContext other) {
        return Objects.equal(tdeOptions, other.tdeOptions) && Objects.equal(compressor, other.compressor) && Arrays.equals(iv, other.iv);
    }
