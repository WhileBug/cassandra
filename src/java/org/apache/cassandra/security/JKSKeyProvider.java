...
public class JKSKeyProvider implements KeyProvider {
    ...
    public static transient org.slf4j.Logger logger_IC = org.slf4j.LoggerFactory.getLogger(JKSKeyProvider.class);

    private static final transient Logger logger = LoggerFactory.getLogger(JKSKeyProvider.class);

    static final transient String PROP_KEYSTORE = "keystore";

    static final transient String PROP_KEYSTORE_PW = "keystore_password";

    static final transient String PROP_KEYSTORE_TYPE = "store_type";

    static final transient String PROP_KEY_PW = "key_password";

    private final transient KeyStore store;

    private final transient boolean isJceks;

    private final transient TransparentDataEncryptionOptions options;
