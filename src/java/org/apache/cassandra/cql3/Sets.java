...
public abstract class Sets {
    ...
    public static transient org.slf4j.Logger logger_IC = org.slf4j.LoggerFactory.getLogger(Sets.class);
    ...
    public static class Value extends Term.Terminal {
        ...
        public final transient SortedSet<ByteBuffer> elements;
        ...
        public boolean equals(SetType st, Value v) {
            ...
            while (thisIter.hasNext()) if (elementsType.compare(thisIter.next(), thatIter.next()) != 0)
                return false;
            return true;
        }
    }
    ...
    public static class DelayedValue extends Term.NonTerminal {
        ...
        private final transient Set<Term> elements;
    ...
    public static class Discarder extends Operation {
        ...
        public void execute(DecoratedKey partitionKey, UpdateParameters params) throws InvalidRequestException {
            ...
            for (ByteBuffer bb : toDiscard) params.addTombstone(column, CellPath.create(bb));
        }
    }
