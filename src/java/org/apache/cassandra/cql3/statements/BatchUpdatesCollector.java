...
final class BatchUpdatesCollector implements UpdatesCollector {
    ...
    public static transient org.slf4j.Logger logger_IC = org.slf4j.LoggerFactory.getLogger(BatchUpdatesCollector.class);
     ...
     */
    private final transient Map<TableId, HashMultiset<ByteBuffer>> perPartitionKeyCounts;
     ...
     */
    private final transient Map<String, Map<ByteBuffer, IMutationBuilder>> mutationBuilders = Maps.newHashMapWithExpectedSize(1);
    ...
    private static class MutationBuilder implements IMutationBuilder {
        ...
        private final transient Map<TableId, PartitionUpdate.Builder> modifications;

        private final transient DecoratedKey key;

        private final transient String keyspaceName;

        private final transient long createdAt = approxTime.now();
    ...
    private static class CounterMutationBuilder implements IMutationBuilder {
        ...
        private final transient MutationBuilder mutationBuilder;
    ...
    private static class VirtualMutationBuilder implements IMutationBuilder {
        ...
        private final transient HashMap<TableId, PartitionUpdate.Builder> modifications = new HashMap<>();
