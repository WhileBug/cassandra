...
public final class CreateViewStatement extends AlterSchemaStatement {
    ...
    public static transient org.slf4j.Logger logger_IC = org.slf4j.LoggerFactory.getLogger(CreateViewStatement.class);
    ...
    private final transient List<RawSelector> rawColumns;
    ...
    private final transient WhereClause whereClause;
    ...
    public Keyspaces apply(Keyspaces schema) {
         ...
         */
        attrs.validate();
        if (attrs.hasOption(TableParams.Option.DEFAULT_TIME_TO_LIVE) && attrs.getInt(TableParams.Option.DEFAULT_TIME_TO_LIVE.toString(), 0) != 0) {
    ...
    public final static class Raw extends CQLStatement.Raw {
        ...
        private final transient QualifiedName viewName;
        ...
        public CreateViewStatement prepare(ClientState state) {
            ...
            return new CreateViewStatement(keyspaceName, tableName.getName(), viewName.getName(), rawColumns, partitionKeyColumns, clusteringColumns, whereClause, clusteringOrder, attrs, ifNotExists);
        }
