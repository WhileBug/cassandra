...
public final class CreateTypeStatement extends AlterSchemaStatement {
    ...
    public static transient org.slf4j.Logger logger_IC = org.slf4j.LoggerFactory.getLogger(CreateTypeStatement.class);
    ...
    private final transient List<CQL3Type.Raw> rawFieldTypes;
    ...
    public static final class Raw extends CQLStatement.Raw {
        ...
        private final transient List<FieldIdentifier> fieldNames = new ArrayList<>();

        private final transient List<CQL3Type.Raw> rawFieldTypes = new ArrayList<>();
        ...
        public void addToRawBuilder(Types.RawBuilder builder) {
            builder.add(name.getStringTypeName(), fieldNames.stream().map(FieldIdentifier::toString).collect(toList()), rawFieldTypes.stream().map(CQL3Type.Raw::toString).collect(toList()));
        }
    }
}
