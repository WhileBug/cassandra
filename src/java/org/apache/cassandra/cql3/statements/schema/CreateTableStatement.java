...
public final class CreateTableStatement extends AlterSchemaStatement {
    ...
    public static TableMetadata.Builder parse(String cql, String keyspace) {
        return // works around a messy ClientState/QueryProcessor class init deadlock
        CQLFragmentParser.parseAny(CqlParser::createTableStatement, cql, "CREATE TABLE").keyspace(keyspace).prepare(null).builder(Types.none());
    }
