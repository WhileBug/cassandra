...
public final class KeyspaceAttributes extends PropertyDefinitions {
    ...
    public static transient org.slf4j.Logger logger_IC = org.slf4j.LoggerFactory.getLogger(KeyspaceAttributes.class);

    public static transient org.slf4j.Logger logger_IC = org.slf4j.LoggerFactory.getLogger(KeyspaceAttributes.class);

    private static final transient Set<String> validKeywords;

    private static final transient Set<String> obsoleteKeywords;

    static {
        ImmutableSet.Builder<String> validBuilder = ImmutableSet.builder();
        for (Option option : Option.values()) validBuilder.add(option.toString());
