...
public final class CreateTriggerStatement extends AlterSchemaStatement {
    ...
    public static transient org.slf4j.Logger logger_IC = org.slf4j.LoggerFactory.getLogger(CreateTriggerStatement.class);
    ...
    private final transient String triggerClass;
