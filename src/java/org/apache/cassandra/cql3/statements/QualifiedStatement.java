...
public abstract class QualifiedStatement extends CQLStatement.Raw {
    ...
    public static transient org.slf4j.Logger logger_IC = org.slf4j.LoggerFactory.getLogger(QualifiedStatement.class);

    final transient QualifiedName qualifiedName;
