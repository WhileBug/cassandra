...
public abstract class PermissionsManagementStatement extends AuthorizationStatement {
    ...
    public static transient org.slf4j.Logger logger_IC = org.slf4j.LoggerFactory.getLogger(PermissionsManagementStatement.class);
    ...
    public void authorize(ClientState state) throws UnauthorizedException {
        ...
        for (Permission p : permissions) state.ensurePermission(p, resource);
    }
