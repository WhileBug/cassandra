...
final class SingleTableUpdatesCollector implements UpdatesCollector {
    ...
    public static transient org.slf4j.Logger logger_IC = org.slf4j.LoggerFactory.getLogger(SingleTableUpdatesCollector.class);
     ...
     */
    private final transient HashMultiset<ByteBuffer> perPartitionKeyCounts;

    /**
     * the partition update builders per key
     */
    private final transient Map<ByteBuffer, PartitionUpdate.Builder> puBuilders;

    /**
     * if it is a counter table, we will set this
     */
    private transient ConsistencyLevel counterConsistencyLevel = null;
