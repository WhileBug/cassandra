...
public abstract class Maps {
    ...
    public static transient org.slf4j.Logger logger_IC = org.slf4j.LoggerFactory.getLogger(Maps.class);
    ...
    public static class Literal extends Term.Raw {
        ...
        public final transient List<Pair<Term.Raw, Term.Raw>> entries;
    ...
    public static class Value extends Term.Terminal {
        ...
        public final transient SortedMap<ByteBuffer, ByteBuffer> map;
    ...
    public static class DelayedValue extends Term.NonTerminal {
        ...
        private final transient Map<Term, Term> elements;
    ...
    public static class SetterByKey extends Operation {
        ...
        private final transient Term k;
