...
public class ColumnSpecification {
    ...
    public static transient org.slf4j.Logger logger_IC = org.slf4j.LoggerFactory.getLogger(ColumnSpecification.class);

    public final transient String ksName;

    public final transient String cfName;

    public final transient ColumnIdentifier name;

    public final transient AbstractType<?> type;
