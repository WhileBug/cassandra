...
public abstract class AggregateFcts {
    ...
    public static transient org.slf4j.Logger logger_IC = org.slf4j.LoggerFactory.getLogger(AggregateFcts.class);
     ...
     * is specified.
     */
    public static final transient AggregateFunction countRowsFunction = new NativeAggregateFunction("countRows", LongType.instance) {
     ...
     */
    public static final transient AggregateFunction sumFunctionForDecimal = new NativeAggregateFunction("sum", DecimalType.instance, DecimalType.instance) {
     ...
     */
    public static final transient AggregateFunction avgFunctionForDecimal = new NativeAggregateFunction("avg", DecimalType.instance, DecimalType.instance) {
     ...
     */
    public static final transient AggregateFunction sumFunctionForVarint = new NativeAggregateFunction("sum", IntegerType.instance, IntegerType.instance) {
     ...
     */
    public static final transient AggregateFunction avgFunctionForVarint = new NativeAggregateFunction("avg", IntegerType.instance, IntegerType.instance) {
     ...
     */
    public static final transient AggregateFunction sumFunctionForByte = new NativeAggregateFunction("sum", ByteType.instance, ByteType.instance) {
     ...
     */
    public static final transient AggregateFunction avgFunctionForByte = new NativeAggregateFunction("avg", ByteType.instance, ByteType.instance) {
     ...
     */
    public static final transient AggregateFunction sumFunctionForShort = new NativeAggregateFunction("sum", ShortType.instance, ShortType.instance) {
     ...
     */
    public static final transient AggregateFunction avgFunctionForShort = new NativeAggregateFunction("avg", ShortType.instance, ShortType.instance) {
     ...
     */
    public static final transient AggregateFunction sumFunctionForInt32 = new NativeAggregateFunction("sum", Int32Type.instance, Int32Type.instance) {
     ...
     */
    public static final transient AggregateFunction avgFunctionForInt32 = new NativeAggregateFunction("avg", Int32Type.instance, Int32Type.instance) {
     ...
     */
    public static final transient AggregateFunction sumFunctionForLong = new NativeAggregateFunction("sum", LongType.instance, LongType.instance) {
     ...
     */
    public static final transient AggregateFunction avgFunctionForLong = new NativeAggregateFunction("avg", LongType.instance, LongType.instance) {
     ...
     */
    public static final transient AggregateFunction sumFunctionForFloat = new NativeAggregateFunction("sum", FloatType.instance, FloatType.instance) {
     ...
     */
    public static final transient AggregateFunction avgFunctionForFloat = new NativeAggregateFunction("avg", FloatType.instance, FloatType.instance) {
     ...
     */
    public static final transient AggregateFunction sumFunctionForDouble = new NativeAggregateFunction("sum", DoubleType.instance, DoubleType.instance) {
    ...
    private static abstract class FloatSumAggregate implements AggregateFunction.Aggregate {
        ...
        private transient double compensation;

        private transient double simpleSum;

        private final transient AbstractType numberType;
    ...
    private static abstract class FloatAvgAggregate implements AggregateFunction.Aggregate {
        ...
        private transient BigDecimal bigSum = null;

        private transient boolean overflow = false;
     ...
     */
    public static final transient AggregateFunction avgFunctionForDouble = new NativeAggregateFunction("avg", DoubleType.instance, DoubleType.instance) {
     ...
     */
    public static final transient AggregateFunction sumFunctionForCounter = new NativeAggregateFunction("sum", CounterColumnType.instance, CounterColumnType.instance) {
     ...
     */
    public static final transient AggregateFunction avgFunctionForCounter = new NativeAggregateFunction("avg", CounterColumnType.instance, CounterColumnType.instance) {
     ...
     */
    public static final transient AggregateFunction minFunctionForCounter = new NativeAggregateFunction("min", CounterColumnType.instance, CounterColumnType.instance) {
     ...
     */
    public static final transient AggregateFunction maxFunctionForCounter = new NativeAggregateFunction("max", CounterColumnType.instance, CounterColumnType.instance) {
    ...
    private static abstract class AvgAggregate implements AggregateFunction.Aggregate {
        ...
        private transient BigInteger bigSum = null;
