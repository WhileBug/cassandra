...
public final class UDFContextImpl implements UDFContext {
    ...
    public static transient org.slf4j.Logger logger_IC = org.slf4j.LoggerFactory.getLogger(UDFContextImpl.class);

    private final transient KeyspaceMetadata keyspaceMetadata;

    private final transient Map<String, TypeCodec<Object>> byName = new HashMap<>();

    private final transient TypeCodec<Object>[] argCodecs;

    private final transient TypeCodec<Object> returnCodec;
