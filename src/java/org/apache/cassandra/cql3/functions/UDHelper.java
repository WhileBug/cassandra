...
public final class UDHelper {
    ...
    public static transient org.slf4j.Logger logger_IC = org.slf4j.LoggerFactory.getLogger(UDHelper.class);

    public static transient org.slf4j.Logger logger_IC = org.slf4j.LoggerFactory.getLogger(UDHelper.class);

    private static final transient CodecRegistry codecRegistry = new CodecRegistry();
