...
public class FromJsonFct extends NativeScalarFunction {
    ...
    public static transient org.slf4j.Logger logger_IC = org.slf4j.LoggerFactory.getLogger(FromJsonFct.class);

    public static transient org.slf4j.Logger logger_IC = org.slf4j.LoggerFactory.getLogger(FromJsonFct.class);

    public static final transient FunctionName NAME = FunctionName.nativeFunction("fromjson");

    private static final transient Map<AbstractType<?>, FromJsonFct> instances = new ConcurrentHashMap<>();
