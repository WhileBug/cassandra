...
final class ScriptBasedUDFunction extends UDFunction {
    ...
    public static transient org.slf4j.Logger logger_IC = org.slf4j.LoggerFactory.getLogger(ScriptBasedUDFunction.class);

    public static transient org.slf4j.Logger logger_IC = org.slf4j.LoggerFactory.getLogger(ScriptBasedUDFunction.class);

    private static final transient ProtectionDomain protectionDomain;

    private static final transient AccessControlContext accessControlContext;
    ...
    // 
    private static final transient String[] allowedPackagesArray = { // following required by jdk.nashorn.internal.objects.Global.initJavaAccess()
    // following required by Nashorn runtime
    "", // following required by Nashorn runtime
    "com", // following required by Nashorn runtime
    "edu", // following required by Nashorn runtime
    "java", // following required by Nashorn runtime
    "javax", // following required by Nashorn runtime
    "javafx", // following required by Nashorn runtime
    "org", // Nashorn / Java 11
    "java.lang", // Nashorn / Java 11
    "java.lang.invoke", // Nashorn / Java 11
    "java.lang.reflect", // Nashorn / Java 11
    "java.nio.charset", // Nashorn / Java 11
    "java.util", // Nashorn / Java 11
    "java.util.concurrent", // Nashorn / Java 11
    "javax.script", // Nashorn / Java 11
    "sun.reflect", // Nashorn / Java 11
    "jdk.internal.org.objectweb.asm.commons", // Nashorn / Java 11
    "jdk.nashorn.internal.runtime", // Nashorn / Java 11
    "jdk.nashorn.internal.runtime.linker", // following required by Java Driver
    "java.lang.ref", // following required by Java Driver
    "java.io", // following required by Java Driver
    "java.util.function", // following required by Java Driver
    "jdk.dynalink.linker", // following required by Java Driver
    "jdk.internal.org.objectweb.asm", // following required by Java Driver
    "jdk.internal.reflect", // following required by Java Driver
    "jdk.nashorn.internal.scripts", // following required by UDF
    "java.math", // following required by UDF
    "java.nio", // following required by UDF
    "java.text", // following required by UDF
    "com.google.common.base", // following required by UDF
    "com.google.common.collect", // following required by UDF
    "com.google.common.reflect", "org.apache.cassandra.cql3.functions.types", "org.apache.cassandra.cql3.functions.types.exceptions", "org.apache.cassandra.cql3.functions.types.utils" };
    ...
    private static final transient UDFExecutorService executor = new UDFExecutorService(new NamedThreadFactory("UserDefinedScriptFunctions", Thread.MIN_PRIORITY, udfClassLoader, new SecurityThreadGroup("UserDefinedScriptFunctions", Collections.unmodifiableSet(new HashSet<>(Arrays.asList(allowedPackagesArray))), UDFunction::initializeThread)), "userscripts");

    private static final transient ClassFilter classFilter = clsName -> secureResource(clsName.replace('.', '/') + ".class");

    private static final transient NashornScriptEngine scriptEngine;
    ...
    private final transient CompiledScript script;

    private final transient Object udfContextBinding;
    ...
    private final class UDFContextWrapper extends AbstractJSObject {
        ...
        private final transient AbstractJSObject fRetUDT;

        private final transient AbstractJSObject fArgUDT;

        private final transient AbstractJSObject fRetTup;

        private final transient AbstractJSObject fArgTup;
