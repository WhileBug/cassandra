...
public abstract class AbstractFunction implements Function {
    ...
    public static transient org.slf4j.Logger logger_IC = org.slf4j.LoggerFactory.getLogger(AbstractFunction.class);

    public static transient org.slf4j.Logger logger_IC = org.slf4j.LoggerFactory.getLogger(AbstractFunction.class);

    protected final transient FunctionName name;

    protected final transient List<AbstractType<?>> argTypes;

    protected final transient AbstractType<?> returnType;
    ...
    public String toString() {
        return new CqlBuilder().append(name).append(" : (").appendWithSeparators(argTypes, (b, t) -> b.append(toCqlString(t)), ", ").append(") -> ").append(returnType).toString();
    }
    ...
    public String elementName() {
        return new CqlBuilder().append(name.name).append('(').appendWithSeparators(argTypes, (b, t) -> b.append(toCqlString(t)), ", ").append(')').toString();
    }
    ...
    public String columnName(List<String> columnNames) {
        return new StrBuilder(name().toString()).append('(').appendWithSeparators(columnNames, ", ").append(')').toString();
    }
}
