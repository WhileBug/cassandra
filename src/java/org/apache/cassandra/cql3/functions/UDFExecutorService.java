...
final class UDFExecutorService extends JMXEnabledThreadPoolExecutor {
    ...
    public static transient org.slf4j.Logger logger_IC = org.slf4j.LoggerFactory.getLogger(UDFExecutorService.class);

    private static transient int KEEPALIVE = Integer.getInteger("cassandra.udf_executor_thread_keepalive_ms", 30000);
