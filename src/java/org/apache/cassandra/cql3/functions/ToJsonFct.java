...
public class ToJsonFct extends NativeScalarFunction {
    ...
    public static transient org.slf4j.Logger logger_IC = org.slf4j.LoggerFactory.getLogger(ToJsonFct.class);

    public static final transient FunctionName NAME = FunctionName.nativeFunction("tojson");

    private static final transient Map<AbstractType<?>, ToJsonFct> instances = new ConcurrentHashMap<>();
