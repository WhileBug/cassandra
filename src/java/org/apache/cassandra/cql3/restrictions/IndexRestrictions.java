...
public class IndexRestrictions {
    ...
    public static transient org.slf4j.Logger logger_IC = org.slf4j.LoggerFactory.getLogger(IndexRestrictions.class);

    public static final transient String INDEX_NOT_FOUND = "Invalid index expression, index %s not found for %s";

    public static final transient String INVALID_INDEX = "Target index %s cannot be used to query %s";

    public static final transient String CUSTOM_EXPRESSION_NOT_SUPPORTED = "Index %s does not support custom expressions";

    public static final transient String NON_CUSTOM_INDEX_IN_EXPRESSION = "Only CUSTOM indexes may be used in custom index expressions, %s is not valid";

    public static final transient String MULTIPLE_EXPRESSIONS = "Multiple custom index expressions in a single query are not supported";

    private final transient List<Restrictions> regularRestrictions = new ArrayList<>();

    private final transient List<CustomIndexExpression> customExpressions = new ArrayList<>();
