...
final class ClusteringColumnRestrictions extends RestrictionSetWrapper {
    ...
    public static transient org.slf4j.Logger logger_IC = org.slf4j.LoggerFactory.getLogger(ClusteringColumnRestrictions.class);
     ...
     */
    private final transient boolean allowFiltering;
