...
public final class SingleColumnRelation extends Relation {
    ...
    public static transient org.slf4j.Logger logger_IC = org.slf4j.LoggerFactory.getLogger(SingleColumnRelation.class);

    private final transient ColumnIdentifier entity;

    private final transient Term.Raw mapKey;
    ...
    public Relation renameIdentifier(ColumnIdentifier from, ColumnIdentifier to) {
        return entity.equals(from) ? new SingleColumnRelation(to, mapKey, operator(), value, inValues) : this;
    }
    ...
    public boolean equals(Object o) {
        ...
        return Objects.equals(entity, scr.entity) && Objects.equals(relationType, scr.relationType) && Objects.equals(mapKey, scr.mapKey) && Objects.equals(value, scr.value) && Objects.equals(inValues, scr.inValues);
    }
