...
public abstract class Selector {
    ...
    public static abstract class Factory {
        ...
        public ColumnSpecification getColumnSpecification(TableMetadata table) {
            return new // note that the name is not necessarily
            ColumnSpecification(// note that the name is not necessarily
            table.keyspace, // note that the name is not necessarily
            table.name, // a true column name so we shouldn't intern it
            new ColumnIdentifier(getColumnName(), true), getReturnType());
        }
