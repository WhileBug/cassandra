...
public final class ResultSetBuilder {
    ...
    public static transient org.slf4j.Logger logger_IC = org.slf4j.LoggerFactory.getLogger(ResultSetBuilder.class);
     ...
     */
    private final transient Selectors selectors;
     ...
     */
    transient List<ByteBuffer> current;

    final transient long[] timestamps;

    final transient int[] ttls;
