...
public abstract class ColumnCondition {
    ...
    public static transient org.slf4j.Logger logger_IC = org.slf4j.LoggerFactory.getLogger(ColumnCondition.class);
    ...
    private final transient Terms terms;
    ...
    private static class CollectionElementCondition extends ColumnCondition {
        ...
        private final transient Term collectionElement;
    ...
    private final static class UDTFieldCondition extends ColumnCondition {
        ...
        private final transient FieldIdentifier udtField;
    ...
    public static abstract class Bound {
        ...
        public final transient Operator comparisonOperator;
    ...
    private static final class ElementAccessBound extends Bound {
         ...
         */
        private final transient ByteBuffer collectionElement;
        ...
        private ByteBuffer rowMapValue(MapType<?, ?> type, Row row) {
            ...
            return cell == null ? null : type.getSerializer().getSerializedValue(cell.buffer(), collectionElement, type.getKeysType());
        }
        ...
        private ByteBuffer rowListValue(ListType<?> type, Row row) {
            ...
            Cell<?> cell = getCell(row, column);
            return cell == null ? null : type.getSerializer().getElement(cell.buffer(), getListIndex(collectionElement));
        }
    ...
    private static final class MultiCellCollectionBound extends Bound {
        ...
        private final transient List<Term.Terminal> values;
    ...
    private static final class UDTFieldAccessBound extends Bound {
        ...
        private ByteBuffer rowValue(Row row) {
            ...
            Cell<?> cell = getCell(row, column);
            return cell == null ? null : userType.split(cell.buffer())[userType.fieldPosition(field)];
        }
    ...
    public static class Raw {
        ...
        private final transient List<Term.Raw> inValues;

        private final transient AbstractMarker.INRaw inMarker;

        // Can be null, only used with the syntax "IF m[e] = ..." (in which case it's 'e')
        private final transient Term.Raw collectionElement;
        ...
        private Terms prepareTerms(String keyspace, ColumnSpecification receiver) {
            if (operator.isIN()) {
                return inValues == null ? Terms.ofListMarker(inMarker.prepare(keyspace, receiver), receiver.type) : Terms.of(prepareTerms(keyspace, receiver, inValues));
            }
