...
public abstract class UserTypes {
    ...
    public static transient org.slf4j.Logger logger_IC = org.slf4j.LoggerFactory.getLogger(UserTypes.class);
    ...
    public static class Literal extends Term.Raw {
        ...
        public final transient Map<FieldIdentifier, Term.Raw> entries;
    ...
    public static class Value extends Term.MultiItemTerminal {
        ...
        public boolean equals(UserType userType, Value v) {
            if (elements.length != v.elements.length)
                return false;
            for (int i = 0; i < elements.length; i++) if (userType.fieldType(i).compare(elements[i], v.elements[i]) != 0)
                return false;
            return true;
        }
    ...
    public static class DelayedValue extends Term.NonTerminal {
        ...
        private final transient List<Term> values;
