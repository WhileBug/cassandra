...
public abstract class Constants {
    ...
    public static transient org.slf4j.Logger logger_IC = org.slf4j.LoggerFactory.getLogger(Constants.class);

    public static transient org.slf4j.Logger logger_IC = org.slf4j.LoggerFactory.getLogger(Constants.class);

    private static final transient Logger logger = LoggerFactory.getLogger(Constants.class);
    ...
    public static final transient UnsetLiteral UNSET_LITERAL = new UnsetLiteral();

    public static final transient Value UNSET_VALUE = new Value(ByteBufferUtil.UNSET_BYTE_BUFFER);
    ...
    public static final transient NullLiteral NULL_LITERAL = new NullLiteral();

    public static final transient Term.Terminal NULL_VALUE = new Value(null) {
    ...
    public static class Literal extends Term.Raw {
        ...
        private final transient AbstractType<?> preferedType;
    ...
    public static class Setter extends Operation {
        ...
        public void execute(DecoratedKey partitionKey, UpdateParameters params) throws InvalidRequestException {
            ...
            else if (// use reference equality and not object equality
