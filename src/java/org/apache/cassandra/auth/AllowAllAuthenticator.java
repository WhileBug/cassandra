...
public class AllowAllAuthenticator implements IAuthenticator {
    ...
    public static transient org.slf4j.Logger logger_IC = org.slf4j.LoggerFactory.getLogger(AllowAllAuthenticator.class);

    private static final transient SaslNegotiator AUTHENTICATOR_INSTANCE = new Negotiator();
