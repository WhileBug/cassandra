...
public class KeyCacheKey extends CacheKey {
    ...
    public static transient org.slf4j.Logger logger_IC = org.slf4j.LoggerFactory.getLogger(KeyCacheKey.class);

    public static transient org.slf4j.Logger logger_IC = org.slf4j.LoggerFactory.getLogger(KeyCacheKey.class);

    public final transient Descriptor desc;

    private static final transient long EMPTY_SIZE = ObjectSizes.measure(new KeyCacheKey(TableMetadata.builder("ks", "tab").addPartitionKeyColumn("pk", UTF8Type.instance).build(), null, ByteBufferUtil.EMPTY_BYTE_BUFFER));
    ...
    public final transient byte[] key;
    ...
    public boolean equals(Object o) {
        ...
        return tableId.equals(that.tableId) && Objects.equals(indexName, that.indexName) && desc.equals(that.desc) && Arrays.equals(key, that.key);
    }
