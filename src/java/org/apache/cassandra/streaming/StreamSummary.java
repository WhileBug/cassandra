...
public class StreamSummary implements Serializable {
    ...
    public static transient org.slf4j.Logger logger_IC = org.slf4j.LoggerFactory.getLogger(StreamSummary.class);

    public static transient org.slf4j.Logger logger_IC = org.slf4j.LoggerFactory.getLogger(StreamSummary.class);

    public static final transient IVersionedSerializer<StreamSummary> serializer = new StreamSummarySerializer();
     ...
     */
    public final transient int files;

    public final transient long totalSize;
