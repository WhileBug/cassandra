...
public class IncomingStreamMessage extends StreamMessage {
    ...
    public static transient org.slf4j.Logger logger_IC = org.slf4j.LoggerFactory.getLogger(IncomingStreamMessage.class);

    public static transient Serializer<IncomingStreamMessage> serializer = new Serializer<IncomingStreamMessage>() {
    ...
    public final transient IncomingStream stream;
    ...
    public String toString() {
        return "IncomingStreamMessage{" + "header=" + header + ", stream=" + stream + '}';
    }
    ...
    public boolean equals(Object o) {
        ...
        return Objects.equals(header, that.header) && Objects.equals(stream, that.stream);
    }
