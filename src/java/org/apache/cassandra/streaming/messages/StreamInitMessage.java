...
public class StreamInitMessage extends StreamMessage {
    ...
    public static transient org.slf4j.Logger logger_IC = org.slf4j.LoggerFactory.getLogger(StreamInitMessage.class);

    public static transient org.slf4j.Logger logger_IC = org.slf4j.LoggerFactory.getLogger(StreamInitMessage.class);

    public static transient Serializer<StreamInitMessage> serializer = new StreamInitMessageSerializer();
    ...
    public StreamSession getOrCreateSession(Channel channel) {
        return StreamResultFuture.createFollower(sessionIndex, planId, streamOperation, from, channel, pendingRepair, previewKind).getSession(from, sessionIndex);
    }
