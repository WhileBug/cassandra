...
public final class Batch {
    ...
    public static transient org.slf4j.Logger logger_IC = org.slf4j.LoggerFactory.getLogger(Batch.class);
    ...
    // time of batch creation (in microseconds)
    public final transient long creationTime;

    // one of these will always be empty
    final transient Collection<Mutation> decodedMutations;

    final transient Collection<ByteBuffer> encodedMutations;
