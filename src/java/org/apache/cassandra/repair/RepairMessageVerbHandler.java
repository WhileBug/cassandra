...
public class RepairMessageVerbHandler implements IVerbHandler<RepairMessage> {
    ...
    public static transient org.slf4j.Logger logger_IC = org.slf4j.LoggerFactory.getLogger(RepairMessageVerbHandler.class);

    public static transient RepairMessageVerbHandler instance = new RepairMessageVerbHandler();

    private static final transient Logger logger = LoggerFactory.getLogger(RepairMessageVerbHandler.class);
        ...
        try {
            switch(message.verb()) {
                ...
                case VALIDATION_REQ:
                    ...
                    Validator validator = new Validator(desc, message.from(), validationRequest.nowInSec, isIncremental(desc.parentSessionId), previewKind(desc.parentSessionId));
