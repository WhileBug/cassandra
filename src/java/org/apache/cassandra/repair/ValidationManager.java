...
public class ValidationManager {
    ...
    public static transient org.slf4j.Logger logger_IC = org.slf4j.LoggerFactory.getLogger(ValidationManager.class);

    private static final transient Logger logger = LoggerFactory.getLogger(ValidationManager.class);

    public static final transient ValidationManager instance = new ValidationManager();
    ...
    private static MerkleTrees createMerkleTrees(ValidationPartitionIterator validationIterator, Collection<Range<Token>> ranges, ColumnFamilyStore cfs) {
        ...
        long availableBytes = (DatabaseDescriptor.getRepairSessionSpaceInMegabytes() * 1048576) / cfs.keyspace.getReplicationStrategy().getReplicationFactor().allReplicas;
