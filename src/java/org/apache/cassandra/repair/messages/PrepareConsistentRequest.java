...
public class PrepareConsistentRequest extends RepairMessage {
    ...
    public static transient org.slf4j.Logger logger_IC = org.slf4j.LoggerFactory.getLogger(PrepareConsistentRequest.class);
    ...
    public final transient Set<InetAddressAndPort> participants;
    ...
    public String toString() {
        return "PrepareConsistentRequest{" + "parentSession=" + parentSession + ", coordinator=" + coordinator + ", participants=" + participants + '}';
    }

    public static final transient IVersionedSerializer<PrepareConsistentRequest> serializer = new IVersionedSerializer<PrepareConsistentRequest>() {
