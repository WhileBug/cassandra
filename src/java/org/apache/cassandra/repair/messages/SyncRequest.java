...
public class SyncRequest extends RepairMessage {
    ...
    public static transient org.slf4j.Logger logger_IC = org.slf4j.LoggerFactory.getLogger(SyncRequest.class);

    public static transient org.slf4j.Logger logger_IC = org.slf4j.LoggerFactory.getLogger(SyncRequest.class);

    public final transient InetAddressAndPort initiator;

    public final transient InetAddressAndPort src;

    public final transient InetAddressAndPort dst;

    public final transient Collection<Range<Token>> ranges;

    public final transient PreviewKind previewKind;

    public final transient boolean asymmetric;
    ...
    public boolean equals(Object o) {
        ...
        return desc.equals(req.desc) && initiator.equals(req.initiator) && src.equals(req.src) && dst.equals(req.dst) && ranges.equals(req.ranges) && previewKind == req.previewKind && asymmetric == req.asymmetric;
    }
    ...
    public static final transient IVersionedSerializer<SyncRequest> serializer = new IVersionedSerializer<SyncRequest>() {
        ...
        public SyncRequest deserialize(DataInputPlus in, int version) throws IOException {
            ...
            for (int i = 0; i < rangesCount; ++i) ranges.add((Range<Token>) AbstractBounds.tokenSerializer.deserialize(in, IPartitioner.global(), version));
    ...
    public String toString() {
        return "SyncRequest{" + "initiator=" + initiator + ", src=" + src + ", dst=" + dst + ", ranges=" + ranges + ", previewKind=" + previewKind + ", asymmetric=" + asymmetric + "} " + super.toString();
    }
}
