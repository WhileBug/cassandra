...
public class CommonRange {
    ...
    public static transient org.slf4j.Logger logger_IC = org.slf4j.LoggerFactory.getLogger(CommonRange.class);

    public static transient org.slf4j.Logger logger_IC = org.slf4j.LoggerFactory.getLogger(CommonRange.class);

    public final transient ImmutableSet<InetAddressAndPort> endpoints;

    public final transient ImmutableSet<InetAddressAndPort> transEndpoints;

    public final transient Collection<Range<Token>> ranges;

    public final transient boolean hasSkippedReplicas;
    ...
    public boolean equals(Object o) {
        ...
        return Objects.equals(endpoints, that.endpoints) && Objects.equals(transEndpoints, that.transEndpoints) && Objects.equals(ranges, that.ranges) && hasSkippedReplicas == that.hasSkippedReplicas;
    }
    ...
    public String toString() {
        return "CommonRange{" + "endpoints=" + endpoints + ", transEndpoints=" + transEndpoints + ", ranges=" + ranges + ", hasSkippedReplicas=" + hasSkippedReplicas + '}';
    }
}
