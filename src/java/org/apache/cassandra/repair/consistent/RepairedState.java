...
public class RepairedState {
    ...
    public static transient org.slf4j.Logger logger_IC = org.slf4j.LoggerFactory.getLogger(RepairedState.class);

    public static transient org.slf4j.Logger logger_IC = org.slf4j.LoggerFactory.getLogger(RepairedState.class);

    static class Level {

        final transient List<Range<Token>> ranges;

        final transient long repairedAt;

        private static final transient Comparator<Level> timeComparator = Comparator.comparingLong(l -> -l.repairedAt);
        ...
        public boolean equals(Object o) {
            ...
            if (o == null || getClass() != o.getClass())
                return false;
            Level level = (Level) o;
            return repairedAt == level.repairedAt && Objects.equals(ranges, level.ranges);
        }
        ...
        public String toString() {
            return "Level{" + "ranges=" + ranges + ", repairedAt=" + repairedAt + '}';
        }
    }
    ...
    public static class Section {
        ...
        private static final transient Comparator<Section> tokenComparator = (l, r) -> l.range.left.compareTo(r.range.left);
        ...
        public boolean equals(Object o) {
            ...
            return repairedAt == section.repairedAt && Objects.equals(range, section.range);
        }
        ...
        @Override
        public String toString() {
            return "Section{" + "range=" + range + ", repairedAt=" + repairedAt + '}';
        }
    }

    public static class Stats {

        public static final transient Stats EMPTY = new Stats(UNREPAIRED_SSTABLE, UNREPAIRED_SSTABLE, Collections.emptyList());

        public final transient long minRepaired;

        public final transient long maxRepaired;

        public final transient List<Section> sections;
    ...
    static class State {
        ...
        final transient ImmutableList<Level> levels;

        final transient ImmutableList<Range<Token>> covered;

        final transient ImmutableList<Section> sections;
        ...
        public boolean equals(Object o) {
            ...
            if (o == null || getClass() != o.getClass())
                return false;
            State state = (State) o;
            return Objects.equals(levels, state.levels) && Objects.equals(covered, state.covered);
        }
        ...
        @Override
        public String toString() {
            return "State{" + "levels=" + levels + ", covered=" + covered + '}';
        }
    }

    private volatile transient State state = new State(Collections.emptyList(), Collections.emptyList(), Collections.emptyList());

    State state() {
        logger_IC.info("[InconsistencyDetector][org.apache.cassandra.repair.consistent.RepairedState.state]=" + org.json.simple.JSONValue.toJSONString(state).replace("\n", "").replace("\r", ""));
        logger_IC.info("[InconsistencyDetector][org.apache.cassandra.repair.consistent.RepairedState.state]=" + org.json.simple.JSONValue.toJSONString(state).replace("\n", "").replace("\r", ""));
        return state;
    }
