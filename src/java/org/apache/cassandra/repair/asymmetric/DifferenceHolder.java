...
public class DifferenceHolder {
    ...
    public static transient org.slf4j.Logger logger_IC = org.slf4j.LoggerFactory.getLogger(DifferenceHolder.class);

    public static transient org.slf4j.Logger logger_IC = org.slf4j.LoggerFactory.getLogger(DifferenceHolder.class);

    private final transient ImmutableMap<InetAddressAndPort, HostDifferences> differences;
    ...
    public String toString() {
        return "DifferenceHolder{" + "differences=" + differences + '}';
    }
