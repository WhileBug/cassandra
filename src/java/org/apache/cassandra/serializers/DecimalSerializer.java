...
public class DecimalSerializer extends TypeSerializer<BigDecimal> {
    ...
    public static transient org.slf4j.Logger logger_IC = org.slf4j.LoggerFactory.getLogger(DecimalSerializer.class);

    public static transient org.slf4j.Logger logger_IC = org.slf4j.LoggerFactory.getLogger(DecimalSerializer.class);

    public static final transient DecimalSerializer instance = new DecimalSerializer();
