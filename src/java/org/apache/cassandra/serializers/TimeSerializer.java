...
public class TimeSerializer extends TypeSerializer<Long> {
    ...
    public static transient org.slf4j.Logger logger_IC = org.slf4j.LoggerFactory.getLogger(TimeSerializer.class);

    public static final transient Pattern timePattern = Pattern.compile("^-?\\d+$");

    public static final transient TimeSerializer instance = new TimeSerializer();
