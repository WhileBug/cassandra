...
public class CompositesSearcher extends CassandraIndexSearcher {
    ...
    public static transient org.slf4j.Logger logger_IC = org.slf4j.LoggerFactory.getLogger(CompositesSearcher.class);
        ...
        return new UnfilteredPartitionIterator() {
            ...
            private boolean prepareNext() {
                while (true) {
                    ...
                    UnfilteredRowIterator // by the next caller of next, or through closing this iterator is this come before.
    ...
    @SuppressWarnings("resource")
    private UnfilteredRowIterator filterStaleEntries(UnfilteredRowIterator dataIter, final ByteBuffer indexValue, final List<IndexEntry> entries, final WriteContext ctx, final int nowInSec) {
        ...
        if (isStaticColumn()) {
            ...
            class Transform extends Transformation {
                ...
                private transient int entriesIdx;
