...
public abstract class CassandraIndexSearcher implements Index.Searcher {
    ...
    public static transient org.slf4j.Logger logger_IC = org.slf4j.LoggerFactory.getLogger(CassandraIndexSearcher.class);

    private static final transient Logger logger = LoggerFactory.getLogger(CassandraIndexSearcher.class);

    private final transient RowFilter.Expression expression;

    protected final transient CassandraIndex index;
