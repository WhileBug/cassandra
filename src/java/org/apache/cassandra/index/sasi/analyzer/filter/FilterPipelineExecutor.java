...
public class FilterPipelineExecutor {
    ...
    public static transient org.slf4j.Logger logger_IC = org.slf4j.LoggerFactory.getLogger(FilterPipelineExecutor.class);

    private static final transient Logger logger = LoggerFactory.getLogger(FilterPipelineExecutor.class);
