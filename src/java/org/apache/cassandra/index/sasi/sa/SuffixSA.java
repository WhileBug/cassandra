...
public class SuffixSA extends SA<CharBuffer> {
    ...
    public static transient org.slf4j.Logger logger_IC = org.slf4j.LoggerFactory.getLogger(SuffixSA.class);
    ...
    private class SASuffixIterator extends TermIterator {
        ...
        private static final transient int COMPLETE_BIT = 31;

        private final transient long[] suffixes;

        private transient int current = 0;

        private transient IndexedTerm lastProcessedSuffix;

        private transient TokenTreeBuilder container;
        ...
        public SASuffixIterator() {
            ...
            LongTimSort.sort(suffixes, (a, b) -> {
                ...
                return comparator.compare(aTerm.getSuffix(clearCompleteBit(a) - aTerm.getPosition()), bTerm.getSuffix(clearCompleteBit(b) - bTerm.getPosition()));
            });
        }
