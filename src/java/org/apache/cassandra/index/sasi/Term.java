...
public class Term {
    ...
    protected final transient MappedBuffer content;

    protected final transient TermSize termSize;

    private final transient boolean hasMarkedPartials;
    ...
    public boolean isPartial() {
        return !termSize.isConstant() && hasMarkedPartials && (content.getShort(content.position()) & (1 << IS_PARTIAL_BIT)) != 0;
    }
