...
public class IndexMode {
    ...
    public static transient org.slf4j.Logger logger_IC = org.slf4j.LoggerFactory.getLogger(IndexMode.class);

    private static final transient Logger logger = LoggerFactory.getLogger(IndexMode.class);

    public static final transient IndexMode NOT_INDEXED = new IndexMode(Mode.PREFIX, true, false, NonTokenizingAnalyzer.class, 0);

    private static final transient Set<AbstractType<?>> TOKENIZABLE_TYPES = new HashSet<AbstractType<?>>() {
    ...
    private static final transient String INDEX_MODE_OPTION = "mode";

    private static final transient String INDEX_ANALYZED_OPTION = "analyzed";

    private static final transient String INDEX_ANALYZER_CLASS_OPTION = "analyzer_class";

    private static final transient String INDEX_IS_LITERAL_OPTION = "is_literal";

    private static final transient String INDEX_MAX_FLUSH_MEMORY_OPTION = "max_compaction_flush_memory_in_mb";

    private static final transient double INDEX_MAX_FLUSH_DEFAULT_MULTIPLIER = 0.15;

    // 1G default for memtable
    private static final transient long DEFAULT_MAX_MEM_BYTES = (long) (1073741824 * INDEX_MAX_FLUSH_DEFAULT_MULTIPLIER);

    public final transient Mode mode;

    public final transient boolean isAnalyzed, isLiteral;

    public final transient Class analyzerClass;

    public final transient long maxCompactionFlushMemoryInBytes;
