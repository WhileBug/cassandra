...
public class Expression {
    ...
    public static transient org.slf4j.Logger logger_IC = org.slf4j.LoggerFactory.getLogger(Expression.class);
    ...
    public final transient AbstractAnalyzer analyzer;

    public final transient ColumnIndex index;

    public final transient AbstractType<?> validator;

    public final transient boolean isLiteral;

    @VisibleForTesting
    protected transient Op operation;

    public transient Bound lower, upper;

    public transient List<ByteBuffer> exclusions = new ArrayList<>();
    ...
    public String toString() {
        return String.format("Expression{name: %s, op: %s, lower: (%s, %s), upper: (%s, %s), exclusions: %s}", index.getColumnName(), operation, lower == null ? "null" : validator.getString(lower.value), lower != null && lower.inclusive, upper == null ? "null" : validator.getString(upper.value), upper != null && upper.inclusive, Iterators.toString(Iterators.transform(exclusions.iterator(), validator::getString)));
    }

    public int hashCode() {
        return new HashCodeBuilder().append(index.getColumnName()).append(operation).append(validator).append(lower).append(upper).append(exclusions).build();
    }
    ...
    public boolean equals(Object other) {
        ...
        return Objects.equals(index.getColumnName(), o.index.getColumnName()) && validator.equals(o.validator) && operation == o.operation && Objects.equals(lower, o.lower) && Objects.equals(upper, o.upper) && exclusions.equals(o.exclusions);
    }

    public static class Bound {

        public final transient ByteBuffer value;

        public final transient boolean inclusive;
