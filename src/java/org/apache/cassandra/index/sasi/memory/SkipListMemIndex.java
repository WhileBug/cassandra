...
public class SkipListMemIndex extends MemIndex {
    ...
    public static transient org.slf4j.Logger logger_IC = org.slf4j.LoggerFactory.getLogger(SkipListMemIndex.class);

    // average overhead of CSLM
    public static final transient int CSLM_OVERHEAD = 128;

    private final transient ConcurrentSkipListMap<ByteBuffer, ConcurrentSkipListSet<DecoratedKey>> index;
