...
public class KeyRangeIterator extends RangeIterator<Long, Token> {
    ...
    public static transient org.slf4j.Logger logger_IC = org.slf4j.LoggerFactory.getLogger(KeyRangeIterator.class);

    public static transient org.slf4j.Logger logger_IC = org.slf4j.LoggerFactory.getLogger(KeyRangeIterator.class);

    private final transient DKIterator iterator;
    ...
    private static class DKIterator extends AbstractIterator<DecoratedKey> implements PeekingIterator<DecoratedKey> {
        ...
        private final transient Iterator<DecoratedKey> keys;
    ...
    private static class DKToken extends Token {
        ...
        private final transient SortedSet<DecoratedKey> keys;
        ...
        public LongSet getOffsets() {
            ...
            for (DecoratedKey key : keys) offsets.add((long) key.getToken().getTokenValue());
            return offsets;
        }
        ...
        public void merge(CombinedValue<Long> other) {
            ...
            if (o instanceof DKToken) {
                ...
                for (DecoratedKey key : o) keys.add(key);
            }
        }
