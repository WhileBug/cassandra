...
public class TrieMemIndex extends MemIndex {
    ...
    public static transient org.slf4j.Logger logger_IC = org.slf4j.LoggerFactory.getLogger(TrieMemIndex.class);

    private static final transient Logger logger = LoggerFactory.getLogger(TrieMemIndex.class);

    private final transient ConcurrentTrie index;
    ...
    private static abstract class ConcurrentTrie {
        ...
        public static final transient SizeEstimatingNodeFactory NODE_FACTORY = new SizeEstimatingNodeFactory();

        protected final transient ColumnMetadata definition;
    ...
    protected static class ConcurrentPrefixTrie extends ConcurrentTrie {
        ...
        private final transient ConcurrentRadixTree<ConcurrentSkipListSet<DecoratedKey>> trie;
    ...
    protected static class ConcurrentSuffixTrie extends ConcurrentTrie {
        ...
        private final transient ConcurrentSuffixTree<ConcurrentSkipListSet<DecoratedKey>> trie;
    ...
    private static class SizeEstimatingNodeFactory extends SmartArrayBasedNodeFactory {
        ...
        private final transient ThreadLocal<Long> updateSize = ThreadLocal.withInitial(() -> 0L);
