...
abstract class AbstractPatriciaTrie<K, V> extends AbstractTrie<K, V> {
    ...
    public static transient org.slf4j.Logger logger_IC = org.slf4j.LoggerFactory.getLogger(AbstractPatriciaTrie.class);

    public static transient org.slf4j.Logger logger_IC = org.slf4j.LoggerFactory.getLogger(AbstractPatriciaTrie.class);

    private static final transient long serialVersionUID = -2303909182832019043L;

    /**
     * The root node of the {@link Trie}.
     */
    final transient TrieEntry<K, V> root = new TrieEntry<>(null, null, -1);
    ...
    public V put(K key, V value) {
        ...
        if (!Tries.isOutOfBoundsIndex(bitIndex)) {
            if (// in 99.999...9% the case
            Tries.isValidBitIndex(bitIndex)) {
                /* NEW KEY+VALUE TUPLE */
    ...
    public Map.Entry<K, V> traverse(Cursor<? super K, ? super V> cursor) {
        ...
        while (entry != null) {
            ...
            switch(decision) {
                ...
                case REMOVE:
                    removeEntry(current);
                    // out of switch, stay in while loop
                    break;
                case REMOVE_AND_EXIT:
    ...
    static class TrieEntry<K, V> extends BasicEntry<K, V> {
        ...
        private static final transient long serialVersionUID = 4596023148184140013L;

        /**
         * The index this entry is comparing.
         */
        protected transient int bitIndex;

        /**
         * The parent of this entry.
         */
        protected transient TrieEntry<K, V> parent;

        /**
         * The left child of this entry.
         */
        protected transient TrieEntry<K, V> left;

        /**
         * The right child of this entry.
         */
        protected transient TrieEntry<K, V> right;

        /**
         * The entry who uplinks to this entry.
         */
        protected transient TrieEntry<K, V> predecessor;
    ...
    abstract class TrieIterator<E> implements Iterator<E> {
         ...
         * For fast-fail
         */
        protected transient int expectedModCount = AbstractPatriciaTrie.this.modCount;

        // the next node to return
        protected transient TrieEntry<K, V> next;

        // the current entry we're on
        protected transient TrieEntry<K, V> current;
