...
public class CombinedTermIterator extends TermIterator {
    ...
    public static transient org.slf4j.Logger logger_IC = org.slf4j.LoggerFactory.getLogger(CombinedTermIterator.class);

    public static transient org.slf4j.Logger logger_IC = org.slf4j.LoggerFactory.getLogger(CombinedTermIterator.class);

    final transient Descriptor descriptor;

    final transient RangeIterator<OnDiskIndex.DataTerm, CombinedTerm> union;

    final transient ByteBuffer min;

    final transient ByteBuffer max;
    ...
    public CombinedTermIterator(Descriptor d, OnDiskIndex... parts) {
        ...
        // assumes all SAs have same comparator
