...
public class TriggerExecutor {
    ...
    public static transient org.slf4j.Logger logger_IC = org.slf4j.LoggerFactory.getLogger(TriggerExecutor.class);

    public static final transient TriggerExecutor instance = new TriggerExecutor();

    private final transient Map<String, ITrigger> cachedTriggers = Maps.newConcurrentMap();

    private final transient ClassLoader parent = Thread.currentThread().getContextClassLoader();

    private volatile transient ClassLoader customClassLoader;
