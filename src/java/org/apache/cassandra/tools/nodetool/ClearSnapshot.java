...
public class ClearSnapshot extends NodeToolCmd {
    ...
    public static transient org.slf4j.Logger logger_IC = org.slf4j.LoggerFactory.getLogger(ClearSnapshot.class);
    ...
    private transient String snapshotName = EMPTY;

    @Option(title = "clear_all_snapshots", name = "--all", description = "Removes all snapshots")
    private transient boolean clearAllSnapshots = false;
