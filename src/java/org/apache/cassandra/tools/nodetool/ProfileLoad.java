...
public class ProfileLoad extends NodeToolCmd {
    ...
    public static transient org.slf4j.Logger logger_IC = org.slf4j.LoggerFactory.getLogger(ProfileLoad.class);
    ...
    private class ResultBuilder {
        ...
        private transient SamplerType type;

        private transient String description;

        private transient AtomicBoolean first;

        private transient Map<String, List<CompositeData>> results;

        private transient List<String> targets;

        private transient List<Pair<String, String>> dataKeys;
