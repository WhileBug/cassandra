...
public class Compact extends NodeToolCmd {
    ...
    public static transient org.slf4j.Logger logger_IC = org.slf4j.LoggerFactory.getLogger(Compact.class);
    ...
    private transient boolean splitOutput = false;
    ...
    private transient boolean userDefined = false;
