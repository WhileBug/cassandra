...
public class DescribeCluster extends NodeToolCmd {
    ...
    public static transient org.slf4j.Logger logger_IC = org.slf4j.LoggerFactory.getLogger(DescribeCluster.class);
    ...
    public void execute(NodeProbe probe) {
        ...
        for (Map.Entry<String, SetHostStatWithPort> dc : dcs.entrySet()) {
            ...
            // total number of nodes in a datacenter
            int totalNodes = 0;
            // number of down nodes in a datacenter
            int downNodes = 0;
