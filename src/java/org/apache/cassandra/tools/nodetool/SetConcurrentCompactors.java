...
public class SetConcurrentCompactors extends NodeTool.NodeToolCmd {
    ...
    public static transient org.slf4j.Logger logger_IC = org.slf4j.LoggerFactory.getLogger(SetConcurrentCompactors.class);
    ...
    private transient Integer concurrentCompactors = null;
