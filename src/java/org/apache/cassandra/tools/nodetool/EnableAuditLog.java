...
public class EnableAuditLog extends NodeToolCmd {
    ...
    public static transient org.slf4j.Logger logger_IC = org.slf4j.LoggerFactory.getLogger(EnableAuditLog.class);
    ...
    private transient String logger = null;
    ...
    private transient String included_keyspaces = null;
    ...
    private transient String excluded_keyspaces = null;
    ...
    private transient String included_categories = null;
    ...
    private transient String excluded_categories = null;
    ...
    private transient String included_users = null;
    ...
    private transient String excluded_users = null;
