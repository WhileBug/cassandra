...
public class Import extends NodeToolCmd {
    ...
    public static transient org.slf4j.Logger logger_IC = org.slf4j.LoggerFactory.getLogger(Import.class);
    ...
    @Option(title = "copy_data", name = { "-p", "--copy-data" }, description = "Copy data from source directories instead of moving them")
    ...
    public void execute(NodeProbe probe) {
        ...
        if (!failedDirs.isEmpty()) {
            ...
            for (String directory : failedDirs) err.println(directory);
            System.exit(1);
        }
    }
}
