...
public class ViewBuildStatus extends NodeTool.NodeToolCmd {
    ...
    public static transient org.slf4j.Logger logger_IC = org.slf4j.LoggerFactory.getLogger(ViewBuildStatus.class);

    public static transient org.slf4j.Logger logger_IC = org.slf4j.LoggerFactory.getLogger(ViewBuildStatus.class);

    private final static transient String SUCCESS = "SUCCESS";
