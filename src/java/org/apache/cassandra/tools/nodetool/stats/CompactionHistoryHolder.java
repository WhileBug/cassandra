...
public class CompactionHistoryHolder implements StatsHolder {
    ...
    public static transient org.slf4j.Logger logger_IC = org.slf4j.LoggerFactory.getLogger(CompactionHistoryHolder.class);

    public static transient org.slf4j.Logger logger_IC = org.slf4j.LoggerFactory.getLogger(CompactionHistoryHolder.class);

    public final transient NodeProbe probe;

    public transient List<String> indexNames;
    ...
    private static class CompactionHistoryRow implements Comparable<CompactionHistoryHolder.CompactionHistoryRow> {
        ...
        private final transient String cfName;

        private final transient long compactedAt;

        private final transient long bytesIn;

        private final transient long bytesOut;

        private final transient String rowMerged;
