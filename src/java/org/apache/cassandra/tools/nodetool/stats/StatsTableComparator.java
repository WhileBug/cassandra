...
public class StatsTableComparator implements Comparator<StatsTable> {
    ...
    public static transient org.slf4j.Logger logger_IC = org.slf4j.LoggerFactory.getLogger(StatsTableComparator.class);

    /**
     * Name of the stat that will be used as the sort key.
     */
    private final transient String sortKey;

    /**
     * Whether data size stats are printed human readable.
     */
    private final transient boolean humanReadable;
    ...
    public int compare(StatsTable stx, StatsTable sty) {
        ...
        if (sortKey.equals("average_live_cells_per_slice_last_five_minutes")) {
            ...
            result = compareDoubles((Double) stx.bloomFilterFalseRatio, (Double) sty.bloomFilterFalseRatio);
            ...
            result = compareDoubles((Double) stx.sstableCompressionRatio, (Double) sty.sstableCompressionRatio);
