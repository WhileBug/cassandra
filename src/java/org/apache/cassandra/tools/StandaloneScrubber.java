...
public class StandaloneScrubber {
    ...
    public static transient org.slf4j.Logger logger_IC = org.slf4j.LoggerFactory.getLogger(StandaloneScrubber.class);

    public static final transient String REINSERT_OVERFLOWED_TTL_OPTION_DESCRIPTION = "Rewrites rows with overflowed expiration date affected by CASSANDRA-14092 with " + "the maximum supported expiration date of 2038-01-19T03:14:06+00:00. " + "The rows are rewritten with the original timestamp incremented by one millisecond " + "to override/supersede any potential tombstone that may have been generated " + "during compaction of the affected rows.";

    private static final transient String TOOL_NAME = "sstablescrub";
    ...
    private static final transient String MANIFEST_CHECK_OPTION = "manifest-check";

    private static final transient String SKIP_CORRUPTED_OPTION = "skip-corrupted";

    private static final transient String NO_VALIDATE_OPTION = "no-validate";

    private static final transient String REINSERT_OVERFLOWED_TTL_OPTION = "reinsert-overflowed-ttl";

    private static final transient String HEADERFIX_OPTION = "header-fix";
    ...
    private static class Options {
        ...
        public transient boolean manifestCheckOnly;

        public transient boolean skipCorrupted;

        public transient boolean noValidate;

        public transient boolean reinserOverflowedTTL;

        public transient HeaderFixMode headerFixMode = HeaderFixMode.VALIDATE;

        enum HeaderFixMode {

            VALIDATE_ONLY, VALIDATE, FIX_ONLY, FIX, OFF;
