...
public class StandaloneVerifier {
    ...
    public static transient org.slf4j.Logger logger_IC = org.slf4j.LoggerFactory.getLogger(StandaloneVerifier.class);

    public static transient org.slf4j.Logger logger_IC = org.slf4j.LoggerFactory.getLogger(StandaloneVerifier.class);

    private static final transient String TOOL_NAME = "sstableverify";

    private static final transient String VERBOSE_OPTION = "verbose";

    private static final transient String EXTENDED_OPTION = "extended";

    private static final transient String DEBUG_OPTION = "debug";

    private static final transient String HELP_OPTION = "help";

    private static final transient String CHECK_VERSION = "check_version";

    private static final transient String MUTATE_REPAIR_STATUS = "mutate_repair_status";

    private static final transient String QUICK = "quick";

    private static final transient String TOKEN_RANGE = "token_range";
    ...
    private static class Options {
        ...
        public transient boolean checkVersion;

        public transient boolean mutateRepairStatus;

        public transient boolean quick;

        public transient Collection<Range<Token>> tokens;
        ...
        public static Options parseArgs(String[] cmdArgs) {
            ...
            try {
                ...
                if (cmd.hasOption(TOKEN_RANGE)) {
                    opts.tokens = Stream.of(cmd.getOptionValues(TOKEN_RANGE)).map(StandaloneVerifier::parseTokenRange).collect(Collectors.toSet());
                } else {
        ...
        public String toString() {
            return "Options{" + "keyspaceName='" + keyspaceName + '\'' + ", cfName='" + cfName + '\'' + ", debug=" + debug + ", verbose=" + verbose + ", extended=" + extended + ", checkVersion=" + checkVersion + ", mutateRepairStatus=" + mutateRepairStatus + ", quick=" + quick + ", tokens=" + tokens + '}';
        }
