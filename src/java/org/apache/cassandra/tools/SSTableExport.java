...
public class SSTableExport {
    ...
    public static transient org.slf4j.Logger logger_IC = org.slf4j.LoggerFactory.getLogger(SSTableExport.class);
    ...
    private static final transient String KEY_OPTION = "k";

    private static final transient String DEBUG_OUTPUT_OPTION = "d";

    private static final transient String EXCLUDE_KEY_OPTION = "x";

    private static final transient String ENUMERATE_KEYS_OPTION = "e";

    private static final transient String RAW_TIMESTAMPS = "t";

    private static final transient String PARTITION_JSON_LINES = "l";
