...
public class SSTableOfflineRelevel {
    ...
    public static transient org.slf4j.Logger logger_IC = org.slf4j.LoggerFactory.getLogger(SSTableOfflineRelevel.class);
    ...
    public static void main(String[] args) throws IOException {
        ...
        if (Schema.instance.getTableMetadataRef(keyspace, columnfamily) == null)
            throw new IllegalArgumentException(String.format("Unknown keyspace/table %s.%s", keyspace, columnfamily));
    ...
    private static class Relevel {
        ...
        private final transient Set<SSTableReader> sstables;

        private final transient int approxExpectedLevels;
        ...
        private void printLeveling(Iterable<SSTableReader> sstables) {
            ...
            for (int i = 0; i <= maxLevel; i++) System.out.println(String.format("L%d=%d", i, leveling.get(i).size()));
        }
