...
public class StandaloneSplitter {
    ...
    public static transient org.slf4j.Logger logger_IC = org.slf4j.LoggerFactory.getLogger(StandaloneSplitter.class);

    public static final transient int DEFAULT_SSTABLE_SIZE = 50;

    private static final transient String TOOL_NAME = "sstablessplit";

    private static final transient String DEBUG_OPTION = "debug";

    private static final transient String HELP_OPTION = "help";

    private static final transient String NO_SNAPSHOT_OPTION = "no-snapshot";

    private static final transient String SIZE_OPTION = "size";
    ...
    private static class Options {
        ...
        public final transient List<String> filenames;

        public transient boolean debug;

        public transient boolean snapshot;

        public transient int sizeInMB;
