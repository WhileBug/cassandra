...
public class StandaloneUpgrader {
    ...
    public static transient org.slf4j.Logger logger_IC = org.slf4j.LoggerFactory.getLogger(StandaloneUpgrader.class);

    private static final transient String TOOL_NAME = "sstableupgrade";

    private static final transient String DEBUG_OPTION = "debug";

    private static final transient String HELP_OPTION = "help";

    private static final transient String KEEP_SOURCE = "keep-source";
    ...
    private static class Options {
        ...
        public final transient String cf;

        public final transient String snapshot;

        public transient boolean debug;

        public transient boolean keepSource;
