...
public class GenerateTokens {
    ...
    public static transient org.slf4j.Logger logger_IC = org.slf4j.LoggerFactory.getLogger(GenerateTokens.class);

    public static transient org.slf4j.Logger logger_IC = org.slf4j.LoggerFactory.getLogger(GenerateTokens.class);

    private static final transient String RF = "rf";

    private static final transient String TOKENS = "tokens";

    private static final transient String NODES = "nodes";

    private static final transient String PARTITIONER = "partitioner";

    private static final transient String RACKS = "racks";

    private static final transient String VERBOSE = "verbose";
    ...
    private static Options getOptions() {
        ...
        options.addOption(null, RACKS, true, "Number of nodes per rack, separated by commas. Must add up to the total node count.\n" + "For example, 'generatetokens -n 30 -t 8 --rf 3 --racks 10,10,10' will generate tokens for\n" + "three racks of 10 nodes each.");
