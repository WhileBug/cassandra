...
public class EndpointMessagingVersions {
    ...
    public static transient org.slf4j.Logger logger_IC = org.slf4j.LoggerFactory.getLogger(EndpointMessagingVersions.class);

    public static transient org.slf4j.Logger logger_IC = org.slf4j.LoggerFactory.getLogger(EndpointMessagingVersions.class);

    private static final transient Logger logger = LoggerFactory.getLogger(EndpointMessagingVersions.class);

    // protocol versions of the other nodes in the cluster
    private final transient ConcurrentMap<InetAddressAndPort, Integer> versions = new NonBlockingHashMap<>();
