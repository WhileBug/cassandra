...
public class FrameEncoderLZ4 extends FrameEncoder {

    public static transient org.slf4j.Logger logger_IC = org.slf4j.LoggerFactory.getLogger(FrameEncoderLZ4.class);

    public static final transient FrameEncoderLZ4 fastInstance = new FrameEncoderLZ4(LZ4Factory.fastestInstance().fastCompressor());
    ...
    public static final transient int HEADER_AND_TRAILER_LENGTH = 12;
