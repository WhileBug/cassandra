...
public final class FrameDecoderCrc extends FrameDecoderWith8bHeader {
    ...
    public static transient org.slf4j.Logger logger_IC = org.slf4j.LoggerFactory.getLogger(FrameDecoderCrc.class);
    ...
    private static final transient int HEADER_AND_TRAILER_LENGTH = 10;
