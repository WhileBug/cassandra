...
public final class ForwardingInfo implements Serializable {
    ...
    public static transient org.slf4j.Logger logger_IC = org.slf4j.LoggerFactory.getLogger(ForwardingInfo.class);

    public static transient org.slf4j.Logger logger_IC = org.slf4j.LoggerFactory.getLogger(ForwardingInfo.class);

    final transient List<InetAddressAndPort> targets;

    final transient long[] messageIds;
    ...
    public boolean useSameMessageID(long id) {
        for (int i = 0; i < messageIds.length; i++) if (id != messageIds[i])
            return false;
        return true;
    }
    ...
    static final transient IVersionedSerializer<ForwardingInfo> serializer = new IVersionedSerializer<ForwardingInfo>() {
