...
class SSTableSimpleWriter extends AbstractSSTableSimpleWriter {
    ...
    public static transient org.slf4j.Logger logger_IC = org.slf4j.LoggerFactory.getLogger(SSTableSimpleWriter.class);

    protected transient DecoratedKey currentKey;

    protected transient PartitionUpdate.Builder update;

    private transient SSTableTxnWriter writer;
