...
public class ValidationMetadata extends MetadataComponent {
    ...
    public static transient org.slf4j.Logger logger_IC = org.slf4j.LoggerFactory.getLogger(ValidationMetadata.class);

    public static final transient IMetadataComponentSerializer serializer = new ValidationMetadataSerializer();

    public final transient String partitioner;
