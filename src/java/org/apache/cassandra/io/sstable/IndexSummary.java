...
public class IndexSummary extends WrappedSharedCloseable {
    ...
    public static transient org.slf4j.Logger logger_IC = org.slf4j.LoggerFactory.getLogger(IndexSummary.class);

    public static transient org.slf4j.Logger logger_IC = org.slf4j.LoggerFactory.getLogger(IndexSummary.class);

    private static final transient Logger logger = LoggerFactory.getLogger(IndexSummary.class);

    public static final transient IndexSummarySerializer serializer = new IndexSummarySerializer();
    ...
    private final transient int sizeAtFullSampling;
    ...
    private final transient Memory offsets;

    private final transient int offsetCount;

    // entries is a list of (partition key, index file offset) pairs
    private final transient Memory entries;

    private final transient long entriesLength;
    ...
    public static class IndexSummarySerializer {
        ...
        public Pair<DecoratedKey, DecoratedKey> deserializeFirstLastKey(DataInputStream in, IPartitioner partitioner) throws IOException {
            ...
            int offsetCount = in.readInt();
            long offheapSize = in.readLong();
            // samplingLevel, fullSamplingSummarySize
            in.skipBytes(8);
