...
public class SnapshotDeletingTask implements Runnable {
    ...
    public static transient org.slf4j.Logger logger_IC = org.slf4j.LoggerFactory.getLogger(SnapshotDeletingTask.class);

    public static transient org.slf4j.Logger logger_IC = org.slf4j.LoggerFactory.getLogger(SnapshotDeletingTask.class);

    private static final transient Logger logger = LoggerFactory.getLogger(SnapshotDeletingTask.class);

    public final transient File path;

    private static final transient Queue<Runnable> failedTasks = new ConcurrentLinkedQueue<>();
