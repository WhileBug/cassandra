...
public class ReducingKeyIterator implements CloseableIterator<DecoratedKey> {
    ...
    public static transient org.slf4j.Logger logger_IC = org.slf4j.LoggerFactory.getLogger(ReducingKeyIterator.class);

    private final transient ArrayList<KeyIterator> iters;

    private volatile transient IMergeIterator<DecoratedKey, DecoratedKey> mi;
