...
public class IndexSummaryRedistribution extends CompactionInfo.Holder {
    ...
    public static transient org.slf4j.Logger logger_IC = org.slf4j.LoggerFactory.getLogger(IndexSummaryRedistribution.class);

    private static final transient Logger logger = LoggerFactory.getLogger(IndexSummaryRedistribution.class);
    ...
    static final transient double UPSAMPLE_THRESHOLD = 1.5;

    static final transient double DOWNSAMPLE_THESHOLD = 0.75;

    private final transient Map<TableId, LifecycleTransaction> transactions;

    private final transient long nonRedistributingOffHeapSize;

    private final transient long memoryPoolBytes;

    private final transient UUID compactionId;

    private volatile transient long remainingSpace;
     ...
     */
    // Transactions are closed in finally outside of this method
    ...
    private void addHooks(ColumnFamilyStore cfs, Map<TableId, LifecycleTransaction> transactions, long oldSize, long newSize) {
        ...
        txn.runOnAbort(() -> {
            ...
            // if new is larger this will be negative, so dec will become a inc
    ...
    private static class ReadRateComparator implements Comparator<SSTableReader> {
        ...
        private final transient Map<SSTableReader, Double> readRates;
    ...
    private static class ResampleEntry {
        ...
        public final transient long newSpaceUsed;

        public final transient int newSamplingLevel;
