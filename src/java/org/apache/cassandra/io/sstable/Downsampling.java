...
public class Downsampling {
    ...
    public static transient org.slf4j.Logger logger_IC = org.slf4j.LoggerFactory.getLogger(Downsampling.class);
     ...
     */
    public static final transient int BASE_SAMPLING_LEVEL = 128;

    private static final transient Map<Integer, List<Integer>> samplePatternCache = new HashMap<>();

    private static final transient Map<Integer, List<Integer>> originalIndexCache = new HashMap<>();
