...
public class LZ4Compressor implements ICompressor {
    ...
    public static transient org.slf4j.Logger logger_IC = org.slf4j.LoggerFactory.getLogger(LZ4Compressor.class);

    private static final transient Logger logger = LoggerFactory.getLogger(LZ4Compressor.class);

    public static final transient String LZ4_FAST_COMPRESSOR = "fast";

    public static final transient String LZ4_HIGH_COMPRESSOR = "high";

    private static final transient Set<String> VALID_COMPRESSOR_TYPES = new HashSet<>(Arrays.asList(LZ4_FAST_COMPRESSOR, LZ4_HIGH_COMPRESSOR));

    private static final transient int DEFAULT_HIGH_COMPRESSION_LEVEL = 9;

    private static final transient String DEFAULT_LZ4_COMPRESSOR_TYPE = LZ4_FAST_COMPRESSOR;

    public static final transient String LZ4_HIGH_COMPRESSION_LEVEL = "lz4_high_compressor_level";

    public static final transient String LZ4_COMPRESSOR_TYPE = "lz4_compressor_type";

    private static final transient int INTEGER_BYTES = 4;

    private static final transient ConcurrentHashMap<Pair<String, Integer>, LZ4Compressor> instances = new ConcurrentHashMap<>();
    ...
    private final transient net.jpountz.lz4.LZ4SafeDecompressor decompressor;

    @VisibleForTesting
    final transient String compressorType;

    @VisibleForTesting
    final transient Integer compressionLevel;
