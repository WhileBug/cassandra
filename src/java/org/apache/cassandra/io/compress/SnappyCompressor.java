...
public class SnappyCompressor implements ICompressor {
    ...
    public static transient org.slf4j.Logger logger_IC = org.slf4j.LoggerFactory.getLogger(SnappyCompressor.class);

    public static final transient SnappyCompressor instance = new SnappyCompressor();

    private static transient Logger logger = LoggerFactory.getLogger(SnappyCompressor.class);
