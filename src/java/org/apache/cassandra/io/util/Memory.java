...
public class Memory implements AutoCloseable {
    ...
    public static transient org.slf4j.Logger logger_IC = org.slf4j.LoggerFactory.getLogger(Memory.class);
    ...
    private static final transient long BYTE_ARRAY_BASE_OFFSET = unsafe.arrayBaseOffset(byte[].class);

    private static final transient boolean bigEndian = ByteOrder.nativeOrder().equals(ByteOrder.BIG_ENDIAN);

    public static final transient ByteBuffer[] NO_BYTE_BUFFERS = new ByteBuffer[0];

    protected transient long peer;
