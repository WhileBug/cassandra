...
public class SimpleCachedBufferPool {
    ...
    public static transient org.slf4j.Logger logger_IC = org.slf4j.LoggerFactory.getLogger(SimpleCachedBufferPool.class);

    private final transient ThreadLocalByteBufferHolder bufferHolder;

    private final transient Queue<ByteBuffer> bufferPool;

    /**
     * The number of buffers currently used.
     */
    private transient AtomicInteger usedBuffers = new AtomicInteger(0);
     ...
     */
    private final transient int maxBufferPoolSize;
    ...
    private final transient BufferType preferredReusableBufferType;
    ...
    public String toString() {
        return new StringBuilder().append("SimpleBufferPool:").append(" usedBuffers:").append(usedBuffers.get()).append(", maxBufferPoolSize:").append(maxBufferPoolSize).append(", bufferSize:").append(bufferSize).toString();
    }
}
