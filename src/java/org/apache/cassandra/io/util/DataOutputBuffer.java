...
public class DataOutputBuffer extends BufferedDataOutputStreamPlus {
    ...
    public static transient org.slf4j.Logger logger_IC = org.slf4j.LoggerFactory.getLogger(DataOutputBuffer.class);
     ...
     */
    static final transient long DOUBLING_THRESHOLD = Long.getLong(Config.PROPERTY_PREFIX + "DOB_DOUBLING_THRESHOLD_MB", 64);

    /*
     * Only recycle OutputBuffers up to 1Mb. Larger buffers will be trimmed back to this size.
     */
    private static final transient int MAX_RECYCLE_BUFFER_SIZE = Integer.getInteger(Config.PROPERTY_PREFIX + "dob_max_recycle_bytes", 1024 * 1024);

    private static final transient int DEFAULT_INITIAL_BUFFER_SIZE = 128;
     ...
     */
    public static final transient FastThreadLocal<DataOutputBuffer> scratchBuffer = new FastThreadLocal<DataOutputBuffer>() {
    ...
    @VisibleForTesting
    static final transient int MAX_ARRAY_SIZE = Integer.MAX_VALUE - 8;
