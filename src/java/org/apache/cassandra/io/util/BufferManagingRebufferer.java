...
public abstract class BufferManagingRebufferer implements Rebufferer, Rebufferer.BufferHolder {
    ...
    public static transient org.slf4j.Logger logger_IC = org.slf4j.LoggerFactory.getLogger(BufferManagingRebufferer.class);

    protected final transient ChunkReader source;
    ...
    @Override
    public void close() {
        // reader must be closed at this point.
        assert offset == -1;
        source.close();
    }
