...
public class SafeMemory extends Memory implements SharedCloseable {
    ...
    public static transient org.slf4j.Logger logger_IC = org.slf4j.LoggerFactory.getLogger(SafeMemory.class);

    private final transient Ref<?> ref;
    ...
    private static final class MemoryTidy implements RefCounted.Tidy {
        ...
        final transient long peer;

        final transient long size;
