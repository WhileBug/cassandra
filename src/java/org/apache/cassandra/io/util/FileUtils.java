...
public final class FileUtils {
    ...
    public static transient org.slf4j.Logger logger_IC = org.slf4j.LoggerFactory.getLogger(FileUtils.class);

    public static final transient Charset CHARSET = StandardCharsets.UTF_8;
    ...
    public static final transient long ONE_KB = 1024;

    public static final transient long ONE_MB = 1024 * ONE_KB;

    public static final transient long ONE_GB = 1024 * ONE_MB;

    public static final transient long ONE_TB = 1024 * ONE_GB;

    private static final transient DecimalFormat df = new DecimalFormat("#.##");

    private static final transient AtomicReference<Optional<FSErrorHandler>> fsErrorHandler = new AtomicReference<>(Optional.empty());

    private static transient Class clsDirectBuffer;

    private static transient MethodHandle mhDirectBufferCleaner;

    private static transient MethodHandle mhCleanerClean;
    ...
    static {
        try {
            ...
            // causes ExceptionInInitializerError, will prevent startup
    ...
    private static final transient File tempDir = new File(JAVA_IO_TMPDIR.getString());

    private static final transient AtomicLong tempFileNum = new AtomicLong();
    ...
    private static final class SafeFileStore extends FileStore {
         ...
         */
        private final transient FileStore fileStore;
