...
public abstract class DataOutputStreamPlus extends OutputStream implements DataOutputPlus {
    ...
    public static transient org.slf4j.Logger logger_IC = org.slf4j.LoggerFactory.getLogger(DataOutputStreamPlus.class);

    // Dummy wrapper channel for derived implementations that don't have a channel
    protected final transient WritableByteChannel channel;
    ...
    private static transient int MAX_BUFFER_SIZE = Integer.getInteger(Config.PROPERTY_PREFIX + "data_output_stream_plus_temp_buffer_size", 8192);
    ...
    private static final transient FastThreadLocal<byte[]> tempBuffer = new FastThreadLocal<byte[]>() {
