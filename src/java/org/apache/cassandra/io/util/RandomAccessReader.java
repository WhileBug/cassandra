...
public class RandomAccessReader extends RebufferingInputStream implements FileDataInput {
    ...
    public static transient org.slf4j.Logger logger_IC = org.slf4j.LoggerFactory.getLogger(RandomAccessReader.class);
    ...
    private transient long markedPointer;

    final transient Rebufferer rebufferer;

    private transient BufferHolder bufferHolder = Rebufferer.EMPTY;
