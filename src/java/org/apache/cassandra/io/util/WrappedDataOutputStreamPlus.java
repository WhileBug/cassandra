...
public class WrappedDataOutputStreamPlus extends UnbufferedDataOutputStreamPlus {
    ...
    public static transient org.slf4j.Logger logger_IC = org.slf4j.LoggerFactory.getLogger(WrappedDataOutputStreamPlus.class);

    protected final transient OutputStream out;
