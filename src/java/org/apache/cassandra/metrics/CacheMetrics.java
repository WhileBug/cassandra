...
public class CacheMetrics {
    ...
    public static transient org.slf4j.Logger logger_IC = org.slf4j.LoggerFactory.getLogger(CacheMetrics.class);
     ...
     */
    public final transient Gauge<Long> capacity;
     ...
     */
    public final transient Gauge<Integer> entries;
     ...
     */
    public final transient Meter requests;

    /**
     * all time cache hit rate
     */
    public final transient Gauge<Double> hitRate;

    /**
     * 1m hit rate
     */
    public final transient Gauge<Double> oneMinuteHitRate;

    /**
     * 5m hit rate
     */
    public final transient Gauge<Double> fiveMinuteHitRate;

    /**
     * 15m hit rate
     */
    public final transient Gauge<Double> fifteenMinuteHitRate;
