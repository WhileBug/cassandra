...
public class KeyspaceMetrics {
    ...
    public static transient org.slf4j.Logger logger_IC = org.slf4j.LoggerFactory.getLogger(KeyspaceMetrics.class);
     ...
     */
    public final transient Gauge<Long> memtableSwitchCount;

    /**
     * Estimated number of tasks pending for this column family
     */
    public final transient Gauge<Long> pendingFlushes;

    /**
     * Estimate of number of pending compactios for this CF
     */
    public final transient Gauge<Long> pendingCompactions;

    /**
     * Disk space used by SSTables belonging to this CF
     */
    public final transient Gauge<Long> liveDiskSpaceUsed;

    /**
     * Total disk space used by SSTables belonging to this CF, including obsolete ones waiting to be GC'd
     */
    public final transient Gauge<Long> totalDiskSpaceUsed;
     ...
     */
    public final transient Histogram sstablesPerReadHistogram;

    /**
     * Tombstones scanned in queries on this Keyspace
     */
    public final transient Histogram tombstoneScannedHistogram;

    /**
     * Live cells scanned in queries on this Keyspace
     */
    public final transient Histogram liveScannedHistogram;

    /**
     * Column update time delta on this Keyspace
     */
    public final transient Histogram colUpdateTimeDeltaHistogram;

    /**
     * time taken acquiring the partition lock for materialized view updates on this keyspace
     */
    public final transient Timer viewLockAcquireTime;

    /**
     * time taken during the local read of a materialized view update
     */
    public final transient Timer viewReadTime;
     ...
     */
    public final transient Counter writeFailedIdealCL;

    /**
     * Ideal CL write latency metrics
     */
    public final transient LatencyMetrics idealCLWriteLatency;
     ...
     */
    public final transient Timer repairTime;

    /**
     * total time spent preparing for repair
     */
    public final transient Timer repairPrepareTime;

    /**
     * Time spent anticompacting
     */
    public final transient Timer anticompactionTime;

    /**
     * total time spent creating merkle trees
     */
    public final transient Timer validationTime;

    /**
     * total time spent syncing data after repair
     */
    public final transient Timer repairSyncTime;

    /**
     * histogram over the number of bytes we have validated
     */
    public final transient Histogram bytesValidated;

    /**
     * histogram over the number of partitions we have validated
     */
    public final transient Histogram partitionsValidated;
     ...
     */
    public final transient Meter confirmedRepairedInconsistencies;
     ...
     */
    public final transient Meter unconfirmedRepairedInconsistencies;
     ...
     */
    public final transient Histogram repairedDataTrackingOverreadRows;

    public final transient Timer repairedDataTrackingOverreadTime;

    public final transient MetricNameFactory factory;
     ...
     */
    private transient Set<ReleasableMetric> allMetrics = Sets.newHashSet();
