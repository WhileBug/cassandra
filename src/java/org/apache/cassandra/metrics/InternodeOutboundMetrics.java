...
public class InternodeOutboundMetrics {
    ...
    public static transient org.slf4j.Logger logger_IC = org.slf4j.LoggerFactory.getLogger(InternodeOutboundMetrics.class);

    public static transient org.slf4j.Logger logger_IC = org.slf4j.LoggerFactory.getLogger(InternodeOutboundMetrics.class);

    public static final transient String TYPE_NAME = "Connection";
     ...
     */
    public static final transient Meter totalExpiredCallbacks = Metrics.meter(DefaultNameFactory.createMetricName(TYPE_NAME, "TotalTimeouts", null));

    /**
     * Number of timeouts for specific IP
     */
    public final transient Meter expiredCallbacks;
     ...
     */
    public final transient Gauge<Integer> largeMessagePendingTasks;

    /**
     * Pending bytes for large message TCP Connections
     */
    public final transient Gauge<Long> largeMessagePendingBytes;

    /**
     * Completed tasks for large message TCP Connections
     */
    public final transient Gauge<Long> largeMessageCompletedTasks;

    /**
     * Completed bytes for large message TCP Connections
     */
    public final transient Gauge<Long> largeMessageCompletedBytes;

    /**
     * Dropped tasks for large message TCP Connections
     */
    public final transient Gauge<Long> largeMessageDropped;

    /**
     * Dropped tasks because of timeout for large message TCP Connections
     */
    public final transient Gauge<Long> largeMessageDroppedTasksDueToTimeout;

    /**
     * Dropped bytes because of timeout for large message TCP Connections
     */
    public final transient Gauge<Long> largeMessageDroppedBytesDueToTimeout;

    /**
     * Dropped tasks because of overload for large message TCP Connections
     */
    public final transient Gauge<Long> largeMessageDroppedTasksDueToOverload;

    /**
     * Dropped bytes because of overload for large message TCP Connections
     */
    public final transient Gauge<Long> largeMessageDroppedBytesDueToOverload;

    /**
     * Dropped tasks because of error for large message TCP Connections
     */
    public final transient Gauge<Long> largeMessageDroppedTasksDueToError;

    /**
     * Dropped bytes because of error for large message TCP Connections
     */
    public final transient Gauge<Long> largeMessageDroppedBytesDueToError;

    /**
     * Pending tasks for small message TCP Connections
     */
    public final transient Gauge<Integer> smallMessagePendingTasks;

    /**
     * Pending bytes for small message TCP Connections
     */
    public final transient Gauge<Long> smallMessagePendingBytes;

    /**
     * Completed tasks for small message TCP Connections
     */
    public final transient Gauge<Long> smallMessageCompletedTasks;

    /**
     * Completed bytes for small message TCP Connections
     */
    public final transient Gauge<Long> smallMessageCompletedBytes;

    /**
     * Dropped tasks for small message TCP Connections
     */
    public final transient Gauge<Long> smallMessageDroppedTasks;

    /**
     * Dropped tasks because of timeout for small message TCP Connections
     */
    public final transient Gauge<Long> smallMessageDroppedTasksDueToTimeout;

    /**
     * Dropped bytes because of timeout for small message TCP Connections
     */
    public final transient Gauge<Long> smallMessageDroppedBytesDueToTimeout;

    /**
     * Dropped tasks because of overload for small message TCP Connections
     */
    public final transient Gauge<Long> smallMessageDroppedTasksDueToOverload;

    /**
     * Dropped bytes because of overload for small message TCP Connections
     */
    public final transient Gauge<Long> smallMessageDroppedBytesDueToOverload;

    /**
     * Dropped tasks because of error for small message TCP Connections
     */
    public final transient Gauge<Long> smallMessageDroppedTasksDueToError;

    /**
     * Dropped bytes because of error for small message TCP Connections
     */
    public final transient Gauge<Long> smallMessageDroppedBytesDueToError;

    /**
     * Pending tasks for small message TCP Connections
     */
    public final transient Gauge<Integer> urgentMessagePendingTasks;

    /**
     * Pending bytes for urgent message TCP Connections
     */
    public final transient Gauge<Long> urgentMessagePendingBytes;

    /**
     * Completed tasks for urgent message TCP Connections
     */
    public final transient Gauge<Long> urgentMessageCompletedTasks;

    /**
     * Completed bytes for urgent message TCP Connections
     */
    public final transient Gauge<Long> urgentMessageCompletedBytes;

    /**
     * Dropped tasks for urgent message TCP Connections
     */
    public final transient Gauge<Long> urgentMessageDroppedTasks;

    /**
     * Dropped tasks because of timeout for urgent message TCP Connections
     */
    public final transient Gauge<Long> urgentMessageDroppedTasksDueToTimeout;

    /**
     * Dropped bytes because of timeout for urgent message TCP Connections
     */
    public final transient Gauge<Long> urgentMessageDroppedBytesDueToTimeout;

    /**
     * Dropped tasks because of overload for urgent message TCP Connections
     */
    public final transient Gauge<Long> urgentMessageDroppedTasksDueToOverload;

    /**
     * Dropped bytes because of overload for urgent message TCP Connections
     */
    public final transient Gauge<Long> urgentMessageDroppedBytesDueToOverload;

    /**
     * Dropped tasks because of error for urgent message TCP Connections
     */
    public final transient Gauge<Long> urgentMessageDroppedTasksDueToError;

    /**
     * Dropped bytes because of error for urgent message TCP Connections
     */
    public final transient Gauge<Long> urgentMessageDroppedBytesDueToError;
