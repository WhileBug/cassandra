...
public class CommitLogMetrics {
    ...
    public static transient org.slf4j.Logger logger_IC = org.slf4j.LoggerFactory.getLogger(CommitLogMetrics.class);

    public static final transient MetricNameFactory factory = new DefaultNameFactory("CommitLog");

    /**
     * Number of completed tasks
     */
    public transient Gauge<Long> completedTasks;

    /**
     * Number of pending tasks
     */
    public transient Gauge<Long> pendingTasks;

    /**
     * Current size used by all the commit log segments
     */
    public transient Gauge<Long> totalCommitLogSize;

    /**
     * Time spent waiting for a CLS to be allocated - under normal conditions this should be zero
     */
    public final transient Timer waitingOnSegmentAllocation;

    /**
     * The time spent waiting on CL sync; for Periodic this is only occurs when the sync is lagging its sync interval
     */
    public final transient Timer waitingOnCommit;

    /**
     * Number and rate of oversized mutations
     */
    public final transient Meter oversizedMutations;
