...
public class CASClientRequestMetrics extends ClientRequestMetrics {
    ...
    public static transient org.slf4j.Logger logger_IC = org.slf4j.LoggerFactory.getLogger(CASClientRequestMetrics.class);

    public final transient Histogram contention;

    public final transient Counter unfinishedCommit;

    public final transient Meter unknownResult;
