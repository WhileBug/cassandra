...
public class CQLMetrics {
    ...
    public static transient org.slf4j.Logger logger_IC = org.slf4j.LoggerFactory.getLogger(CQLMetrics.class);

    public static transient org.slf4j.Logger logger_IC = org.slf4j.LoggerFactory.getLogger(CQLMetrics.class);

    private static final transient MetricNameFactory factory = new DefaultNameFactory("CQL");

    public final transient Counter regularStatementsExecuted;

    public final transient Counter preparedStatementsExecuted;

    public final transient Counter preparedStatementsEvicted;

    public final transient Gauge<Integer> preparedStatementsCount;

    public final transient Gauge<Double> preparedStatementsRatio;
