...
public class LatencyMetrics {
    ...
    public static transient org.slf4j.Logger logger_IC = org.slf4j.LoggerFactory.getLogger(LatencyMetrics.class);

    /**
     * Latency
     */
    public final transient LatencyMetricsTimer latency;

    /**
     * Total latency in micro sec
     */
    public final transient Counter totalLatency;

    /**
     * parent metrics to replicate any updates to *
     */
    private transient List<LatencyMetrics> parents = Lists.newArrayList();

    private final transient List<LatencyMetrics> children = Lists.newArrayList();

    protected final transient MetricNameFactory factory;

    protected final transient MetricNameFactory aliasFactory;

    protected final transient String namePrefix;
    ...
    public class LatencyMetricsTimer extends Timer {
        ...
        transient long releasedLatencyCount = 0;
