...
public class TableMetrics {
    ...
    public static transient org.slf4j.Logger logger_IC = org.slf4j.LoggerFactory.getLogger(TableMetrics.class);

    /**
     * stores metrics that will be rolled into a single global metric
     */
    private static final transient ConcurrentMap<String, Set<Metric>> ALL_TABLE_METRICS = Maps.newConcurrentMap();

    public static final transient long[] EMPTY = new long[0];

    private static final transient MetricNameFactory GLOBAL_FACTORY = new AllTableMetricNameFactory("Table");

    private static final transient MetricNameFactory GLOBAL_ALIAS_FACTORY = new AllTableMetricNameFactory("ColumnFamily");

    public final static transient LatencyMetrics GLOBAL_READ_LATENCY = new LatencyMetrics(GLOBAL_FACTORY, GLOBAL_ALIAS_FACTORY, "Read");

    public final static transient LatencyMetrics GLOBAL_WRITE_LATENCY = new LatencyMetrics(GLOBAL_FACTORY, GLOBAL_ALIAS_FACTORY, "Write");

    public final static transient LatencyMetrics GLOBAL_RANGE_LATENCY = new LatencyMetrics(GLOBAL_FACTORY, GLOBAL_ALIAS_FACTORY, "Range");

    /**
     * Total amount of data stored in the memtable that resides on-heap, including column related overhead and partitions overwritten.
     */
    public final transient Gauge<Long> memtableOnHeapDataSize;

    /**
     * Total amount of data stored in the memtable that resides off-heap, including column related overhead and partitions overwritten.
     */
    public final transient Gauge<Long> memtableOffHeapDataSize;

    /**
     * Total amount of live data stored in the memtable, excluding any data structure overhead
     */
    public final transient Gauge<Long> memtableLiveDataSize;

    /**
     * Total amount of data stored in the memtables (2i and pending flush memtables included) that resides on-heap.
     */
    public final transient Gauge<Long> allMemtablesOnHeapDataSize;

    /**
     * Total amount of data stored in the memtables (2i and pending flush memtables included) that resides off-heap.
     */
    public final transient Gauge<Long> allMemtablesOffHeapDataSize;

    /**
     * Total amount of live data stored in the memtables (2i and pending flush memtables included) that resides off-heap, excluding any data structure overhead
     */
    public final transient Gauge<Long> allMemtablesLiveDataSize;

    /**
     * Total number of columns present in the memtable.
     */
    public final transient Gauge<Long> memtableColumnsCount;

    /**
     * Number of times flush has resulted in the memtable being switched out.
     */
    public final transient Counter memtableSwitchCount;

    /**
     * Current compression ratio for all SSTables
     */
    public final transient Gauge<Double> compressionRatio;

    /**
     * Histogram of estimated partition size (in bytes).
     */
    public final transient Gauge<long[]> estimatedPartitionSizeHistogram;

    /**
     * Approximate number of keys in table.
     */
    public final transient Gauge<Long> estimatedPartitionCount;

    /**
     * Histogram of estimated number of columns.
     */
    public final transient Gauge<long[]> estimatedColumnCountHistogram;

    /**
     * Histogram of the number of sstable data files accessed per read
     */
    public final transient TableHistogram sstablesPerReadHistogram;

    /**
     * (Local) read metrics
     */
    public final transient LatencyMetrics readLatency;

    /**
     * (Local) range slice metrics
     */
    public final transient LatencyMetrics rangeLatency;

    /**
     * (Local) write metrics
     */
    public final transient LatencyMetrics writeLatency;

    /**
     * Estimated number of tasks pending for this table
     */
    public final transient Counter pendingFlushes;

    /**
     * Total number of bytes flushed since server [re]start
     */
    public final transient Counter bytesFlushed;

    /**
     * Total number of bytes written by compaction since server [re]start
     */
    public final transient Counter compactionBytesWritten;

    /**
     * Estimate of number of pending compactios for this table
     */
    public final transient Gauge<Integer> pendingCompactions;

    /**
     * Number of SSTables on disk for this CF
     */
    public final transient Gauge<Integer> liveSSTableCount;

    /**
     * Number of SSTables with old version on disk for this CF
     */
    public final transient Gauge<Integer> oldVersionSSTableCount;

    /**
     * Disk space used by SSTables belonging to this table
     */
    public final transient Counter liveDiskSpaceUsed;

    /**
     * Total disk space used by SSTables belonging to this table, including obsolete ones waiting to be GC'd
     */
    public final transient Counter totalDiskSpaceUsed;

    /**
     * Size of the smallest compacted partition
     */
    public final transient Gauge<Long> minPartitionSize;

    /**
     * Size of the largest compacted partition
     */
    public final transient Gauge<Long> maxPartitionSize;

    /**
     * Size of the smallest compacted partition
     */
    public final transient Gauge<Long> meanPartitionSize;

    /**
     * Number of false positives in bloom filter
     */
    public final transient Gauge<Long> bloomFilterFalsePositives;

    /**
     * Number of false positives in bloom filter from last read
     */
    public final transient Gauge<Long> recentBloomFilterFalsePositives;

    /**
     * False positive ratio of bloom filter
     */
    public final transient Gauge<Double> bloomFilterFalseRatio;

    /**
     * False positive ratio of bloom filter from last read
     */
    public final transient Gauge<Double> recentBloomFilterFalseRatio;

    /**
     * Disk space used by bloom filter
     */
    public final transient Gauge<Long> bloomFilterDiskSpaceUsed;

    /**
     * Off heap memory used by bloom filter
     */
    public final transient Gauge<Long> bloomFilterOffHeapMemoryUsed;

    /**
     * Off heap memory used by index summary
     */
    public final transient Gauge<Long> indexSummaryOffHeapMemoryUsed;

    /**
     * Off heap memory used by compression meta data
     */
    public final transient Gauge<Long> compressionMetadataOffHeapMemoryUsed;

    /**
     * Key cache hit rate  for this CF
     */
    public final transient Gauge<Double> keyCacheHitRate;

    /**
     * Tombstones scanned in queries on this CF
     */
    public final transient TableHistogram tombstoneScannedHistogram;

    /**
     * Live rows scanned in queries on this CF
     */
    public final transient TableHistogram liveScannedHistogram;

    /**
     * Column update time delta on this CF
     */
    public final transient TableHistogram colUpdateTimeDeltaHistogram;

    /**
     * time taken acquiring the partition lock for materialized view updates for this table
     */
    public final transient TableTimer viewLockAcquireTime;

    /**
     * time taken during the local read of a materialized view update
     */
    public final transient TableTimer viewReadTime;

    /**
     * Disk space used by snapshot files which
     */
    public final transient Gauge<Long> trueSnapshotsSize;

    /**
     * Row cache hits, but result out of range
     */
    public final transient Counter rowCacheHitOutOfRange;

    /**
     * Number of row cache hits
     */
    public final transient Counter rowCacheHit;

    /**
     * Number of row cache misses
     */
    public final transient Counter rowCacheMiss;

    /**
     * Number of tombstone read failures
     */
    public final transient Counter tombstoneFailures;

    /**
     * Number of tombstone read warnings
     */
    public final transient Counter tombstoneWarnings;

    /**
     * CAS Prepare metrics
     */
    public final transient LatencyMetrics casPrepare;

    /**
     * CAS Propose metrics
     */
    public final transient LatencyMetrics casPropose;

    /**
     * CAS Commit metrics
     */
    public final transient LatencyMetrics casCommit;

    /**
     * percent of the data that is repaired
     */
    public final transient Gauge<Double> percentRepaired;

    /**
     * Reports the size of sstables in repaired, unrepaired, and any ongoing repair buckets
     */
    public final transient Gauge<Long> bytesRepaired;

    public final transient Gauge<Long> bytesUnrepaired;

    public final transient Gauge<Long> bytesPendingRepair;

    /**
     * Number of started repairs as coordinator on this table
     */
    public final transient Counter repairsStarted;

    /**
     * Number of completed repairs as coordinator on this table
     */
    public final transient Counter repairsCompleted;

    /**
     * time spent anticompacting data before participating in a consistent repair
     */
    public final transient TableTimer anticompactionTime;

    /**
     * time spent creating merkle trees
     */
    public final transient TableTimer validationTime;

    /**
     * time spent syncing data in a repair
     */
    public final transient TableTimer repairSyncTime;

    /**
     * approximate number of bytes read while creating merkle trees
     */
    public final transient TableHistogram bytesValidated;

    /**
     * number of partitions read creating merkle trees
     */
    public final transient TableHistogram partitionsValidated;

    /**
     * number of bytes read while doing anticompaction
     */
    public final transient Counter bytesAnticompacted;

    /**
     * number of bytes where the whole sstable was contained in a repairing range so that we only mutated the repair status
     */
    public final transient Counter bytesMutatedAnticompaction;

    /**
     * ratio of how much we anticompact vs how much we could mutate the repair status
     */
    public final transient Gauge<Double> mutatedAnticompactionGauge;

    public final transient Timer coordinatorReadLatency;

    public final transient Timer coordinatorScanLatency;

    public final transient Timer coordinatorWriteLatency;

    /**
     * Time spent waiting for free memtable space, either on- or off-heap
     */
    public final transient Histogram waitingOnFreeMemtableSpace;

    @Deprecated
    public final transient Counter droppedMutations;

    private final transient MetricNameFactory factory;

    private final transient MetricNameFactory aliasFactory;

    public final transient Counter speculativeRetries;

    public final transient Counter speculativeFailedRetries;

    public final transient Counter speculativeInsufficientReplicas;

    public final transient Gauge<Long> speculativeSampleLatencyNanos;

    public final transient Counter additionalWrites;

    public final transient Gauge<Long> additionalWriteLatencyNanos;

    public final transient Gauge<Integer> unleveledSSTables;
    ...
    public final transient TableMeter confirmedRepairedInconsistencies;
    ...
    public final transient TableMeter unconfirmedRepairedInconsistencies;
    ...
    public final transient TableHistogram repairedDataTrackingOverreadRows;

    public final transient TableTimer repairedDataTrackingOverreadTime;

    /**
     * When sampler activated, will track the most frequently read partitions *
     */
    public final transient Sampler<ByteBuffer> topReadPartitionFrequency;

    /**
     * When sampler activated, will track the most frequently written to partitions *
     */
    public final transient Sampler<ByteBuffer> topWritePartitionFrequency;

    /**
     * When sampler activated, will track the largest mutations *
     */
    public final transient Sampler<ByteBuffer> topWritePartitionSize;

    /**
     * When sampler activated, will track the most frequent partitions with cas contention *
     */
    public final transient Sampler<ByteBuffer> topCasPartitionContention;

    /**
     * When sampler activated, will track the slowest local reads *
     */
    public final transient Sampler<String> topLocalReadQueryTime;
    ...
    public static final transient Gauge<Double> globalPercentRepaired = Metrics.register(GLOBAL_FACTORY.createMetricName("PercentRepaired"), new Gauge<Double>() {
    ...
    public static final transient Gauge<Long> globalBytesRepaired = Metrics.register(GLOBAL_FACTORY.createMetricName("BytesRepaired"), () -> totalNonSystemTablesSize(SSTableReader::isRepaired).left);

    public static final transient Gauge<Long> globalBytesUnrepaired = Metrics.register(GLOBAL_FACTORY.createMetricName("BytesUnrepaired"), () -> totalNonSystemTablesSize(s -> !s.isRepaired() && !s.isPendingRepair()).left);

    public static final transient Gauge<Long> globalBytesPendingRepair = Metrics.register(GLOBAL_FACTORY.createMetricName("BytesPendingRepair"), () -> totalNonSystemTablesSize(SSTableReader::isPendingRepair).left);

    public final transient Meter readRepairRequests;

    public final transient Meter shortReadProtectionRequests;

    public final transient Meter replicaFilteringProtectionRequests;
     ...
     */
    public final transient Histogram rfpRowsCachedPerQuery;

    public final transient EnumMap<SamplerType, Sampler<?>> samplers;

    /**
     * Stores all metrics created that can be used when unregistering
     */
    private final transient Set<ReleasableMetric> all = Sets.newHashSet();
    ...
    public TableMetrics(final ColumnFamilyStore cfs) {
        ...
        oldVersionSSTableCount = createTableGauge("OldVersionSSTableCount", new Gauge<Integer>() {
            ...
            public Integer getValue() {
                int count = 0;
                for (SSTableReader sstable : cfs.getLiveSSTables()) if (!sstable.descriptor.version.isLatestVersion())
                    count++;
                return count;
            }
        });
    ...
    public static class TableMeter {
        ...
        public final transient Meter[] all;

        public final transient Meter table;

        public final transient Meter global;
    ...
    public static class TableHistogram {
        ...
        public final transient Histogram[] all;

        public final transient Histogram cf;

        public final transient Histogram global;
    ...
    public static class TableTimer {
        ...
        public final transient Timer[] all;

        public final transient Timer cf;

        public final transient Timer global;
        ...
        public static class Context implements AutoCloseable {
            ...
            private final transient Timer[] all;
            ...
            public void close() {
                ...
                for (Timer t : all) t.update(duration, TimeUnit.NANOSECONDS);
            }
        }
    }
    ...
    static class TableMetricNameFactory implements MetricNameFactory {
        ...
        private final transient boolean isIndex;
