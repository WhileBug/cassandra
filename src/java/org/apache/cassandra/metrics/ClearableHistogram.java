...
public class ClearableHistogram extends Histogram {
    ...
    public static transient org.slf4j.Logger logger_IC = org.slf4j.LoggerFactory.getLogger(ClearableHistogram.class);

    private final transient DecayingEstimatedHistogramReservoir reservoirRef;
    ...
    private void clearCount() {
        ...
        try {
            ...
            if (// For com.codahale.metrics version >= 4.0
            counter instanceof LongAdder) {
