...
public class GossipDigestSyn {
    ...
    public static transient org.slf4j.Logger logger_IC = org.slf4j.LoggerFactory.getLogger(GossipDigestSyn.class);

    public static final transient IVersionedSerializer<GossipDigestSyn> serializer = new GossipDigestSynSerializer();

    final transient String clusterId;

    final transient String partioner;

    final transient List<GossipDigest> gDigests;
...
class GossipDigestSerializationHelper {
    ...
    public static transient org.slf4j.Logger logger_IC = org.slf4j.LoggerFactory.getLogger(GossipDigestSerializationHelper.class);
...
class GossipDigestSynSerializer implements IVersionedSerializer<GossipDigestSyn> {
    ...
    public static transient org.slf4j.Logger logger_IC = org.slf4j.LoggerFactory.getLogger(GossipDigestSynSerializer.class);
