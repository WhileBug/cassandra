...
public class TokenSerializer {
    ...
    public static transient org.slf4j.Logger logger_IC = org.slf4j.LoggerFactory.getLogger(TokenSerializer.class);

    public static transient org.slf4j.Logger logger_IC = org.slf4j.LoggerFactory.getLogger(TokenSerializer.class);

    private static final transient Logger logger = LoggerFactory.getLogger(TokenSerializer.class);
