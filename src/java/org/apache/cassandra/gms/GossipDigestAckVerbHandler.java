...
public class GossipDigestAckVerbHandler extends GossipVerbHandler<GossipDigestAck> {
    ...
    public static transient org.slf4j.Logger logger_IC = org.slf4j.LoggerFactory.getLogger(GossipDigestAckVerbHandler.class);

    public static transient org.slf4j.Logger logger_IC = org.slf4j.LoggerFactory.getLogger(GossipDigestAckVerbHandler.class);

    public static final transient GossipDigestAckVerbHandler instance = new GossipDigestAckVerbHandler();

    private static final transient Logger logger = LoggerFactory.getLogger(GossipDigestAckVerbHandler.class);
