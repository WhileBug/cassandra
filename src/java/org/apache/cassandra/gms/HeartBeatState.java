...
public class HeartBeatState {
    ...
    public static transient org.slf4j.Logger logger_IC = org.slf4j.LoggerFactory.getLogger(HeartBeatState.class);

    public static transient org.slf4j.Logger logger_IC = org.slf4j.LoggerFactory.getLogger(HeartBeatState.class);

    public static final transient int EMPTY_VERSION = -1;

    public static final transient IVersionedSerializer<HeartBeatState> serializer = new HeartBeatStateSerializer();

    private volatile transient int generation;
    ...
    public static HeartBeatState empty() {
        logger_IC.info("[InconsistencyDetector][org.apache.cassandra.gms.HeartBeatState.EMPTY_VERSION]=" + org.json.simple.JSONValue.toJSONString(EMPTY_VERSION).replace("\n", "").replace("\r", ""));
        logger_IC.info("[InconsistencyDetector][org.apache.cassandra.gms.HeartBeatState.EMPTY_VERSION]=" + org.json.simple.JSONValue.toJSONString(EMPTY_VERSION).replace("\n", "").replace("\r", ""));
...
class HeartBeatStateSerializer implements IVersionedSerializer<HeartBeatState> {
    ...
    public static transient org.slf4j.Logger logger_IC = org.slf4j.LoggerFactory.getLogger(HeartBeatStateSerializer.class);
