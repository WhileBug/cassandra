...
public class CqlInputFormat extends org.apache.hadoop.mapreduce.InputFormat<Long, Row> implements org.apache.hadoop.mapred.InputFormat<Long, Row> {
    ...
    public static transient org.slf4j.Logger logger_IC = org.slf4j.LoggerFactory.getLogger(CqlInputFormat.class);

    public static final transient String MAPRED_TASK_ID = "mapred.task.id";

    private static final transient Logger logger = LoggerFactory.getLogger(CqlInputFormat.class);
    ...
    class SplitCallable implements Callable<List<ColumnFamilySplit>> {
        ...
        private final transient TokenRange tokenRange;

        private final transient List<Host> hosts;
    ...
    private static class SplitFuture extends FutureTask<List<ColumnFamilySplit>> {
        ...
        private final transient SplitCallable splitCallable;
