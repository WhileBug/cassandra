...
public class CqlConfigHelper {
    ...
    public static transient org.slf4j.Logger logger_IC = org.slf4j.LoggerFactory.getLogger(CqlConfigHelper.class);

    private static final transient String INPUT_CQL_COLUMNS_CONFIG = "cassandra.input.columnfamily.columns";

    private static final transient String INPUT_CQL_PAGE_ROW_SIZE_CONFIG = "cassandra.input.page.row.size";

    private static final transient String INPUT_CQL_WHERE_CLAUSE_CONFIG = "cassandra.input.where.clause";

    private static final transient String INPUT_CQL = "cassandra.input.cql";

    private static final transient String USERNAME = "cassandra.username";

    private static final transient String PASSWORD = "cassandra.password";

    private static final transient String INPUT_NATIVE_PORT = "cassandra.input.native.port";

    private static final transient String INPUT_NATIVE_CORE_CONNECTIONS_PER_HOST = "cassandra.input.native.core.connections.per.host";

    private static final transient String INPUT_NATIVE_MAX_CONNECTIONS_PER_HOST = "cassandra.input.native.max.connections.per.host";

    private static final transient String INPUT_NATIVE_MAX_SIMULT_REQ_PER_CONNECTION = "cassandra.input.native.max.simult.reqs.per.connection";

    private static final transient String INPUT_NATIVE_CONNECTION_TIMEOUT = "cassandra.input.native.connection.timeout";

    private static final transient String INPUT_NATIVE_READ_CONNECTION_TIMEOUT = "cassandra.input.native.read.connection.timeout";

    private static final transient String INPUT_NATIVE_RECEIVE_BUFFER_SIZE = "cassandra.input.native.receive.buffer.size";

    private static final transient String INPUT_NATIVE_SEND_BUFFER_SIZE = "cassandra.input.native.send.buffer.size";

    private static final transient String INPUT_NATIVE_SOLINGER = "cassandra.input.native.solinger";

    private static final transient String INPUT_NATIVE_TCP_NODELAY = "cassandra.input.native.tcp.nodelay";

    private static final transient String INPUT_NATIVE_REUSE_ADDRESS = "cassandra.input.native.reuse.address";

    private static final transient String INPUT_NATIVE_KEEP_ALIVE = "cassandra.input.native.keep.alive";

    private static final transient String INPUT_NATIVE_AUTH_PROVIDER = "cassandra.input.native.auth.provider";

    private static final transient String INPUT_NATIVE_SSL_TRUST_STORE_PATH = "cassandra.input.native.ssl.trust.store.path";

    private static final transient String INPUT_NATIVE_SSL_KEY_STORE_PATH = "cassandra.input.native.ssl.key.store.path";

    private static final transient String INPUT_NATIVE_SSL_TRUST_STORE_PASSWARD = "cassandra.input.native.ssl.trust.store.password";

    private static final transient String INPUT_NATIVE_SSL_KEY_STORE_PASSWARD = "cassandra.input.native.ssl.key.store.password";

    private static final transient String INPUT_NATIVE_SSL_CIPHER_SUITES = "cassandra.input.native.ssl.cipher.suites";

    private static final transient String INPUT_NATIVE_PROTOCOL_VERSION = "cassandra.input.native.protocol.version";

    private static final transient String OUTPUT_CQL = "cassandra.output.cql";

    private static final transient String OUTPUT_NATIVE_PORT = "cassandra.output.native.port";
