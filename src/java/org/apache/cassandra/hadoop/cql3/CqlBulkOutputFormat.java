...
public class CqlBulkOutputFormat extends OutputFormat<Object, List<ByteBuffer>> implements org.apache.hadoop.mapred.OutputFormat<Object, List<ByteBuffer>> {
    ...
    public static transient org.slf4j.Logger logger_IC = org.slf4j.LoggerFactory.getLogger(CqlBulkOutputFormat.class);

    public static transient org.slf4j.Logger logger_IC = org.slf4j.LoggerFactory.getLogger(CqlBulkOutputFormat.class);

    private static final transient String OUTPUT_CQL_SCHEMA_PREFIX = "cassandra.table.schema.";

    private static final transient String OUTPUT_CQL_INSERT_PREFIX = "cassandra.table.insert.";

    private static final transient String DELETE_SOURCE = "cassandra.output.delete.source";

    private static final transient String TABLE_ALIAS_PREFIX = "cqlbulkoutputformat.table.alias.";
