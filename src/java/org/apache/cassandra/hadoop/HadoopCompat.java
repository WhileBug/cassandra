...
public class HadoopCompat {
    ...
    public static transient org.slf4j.Logger logger_IC = org.slf4j.LoggerFactory.getLogger(HadoopCompat.class);

    public static transient org.slf4j.Logger logger_IC = org.slf4j.LoggerFactory.getLogger(HadoopCompat.class);

    private static final transient boolean useV21;

    private static final transient Constructor<?> JOB_CONTEXT_CONSTRUCTOR;

    private static final transient Constructor<?> TASK_CONTEXT_CONSTRUCTOR;

    private static final transient Constructor<?> MAP_CONTEXT_CONSTRUCTOR;

    private static final transient Constructor<?> GENERIC_COUNTER_CONSTRUCTOR;

    private static final transient Field READER_FIELD;

    private static final transient Field WRITER_FIELD;

    private static final transient Method GET_CONFIGURATION_METHOD;

    private static final transient Method SET_STATUS_METHOD;

    private static final transient Method GET_COUNTER_METHOD;

    private static final transient Method INCREMENT_COUNTER_METHOD;

    private static final transient Method GET_TASK_ATTEMPT_ID;

    private static final transient Method PROGRESS_METHOD;
