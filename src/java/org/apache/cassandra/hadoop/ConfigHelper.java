...
public class ConfigHelper {
    ...
    public static transient org.slf4j.Logger logger_IC = org.slf4j.LoggerFactory.getLogger(ConfigHelper.class);

    private static final transient String INPUT_PARTITIONER_CONFIG = "cassandra.input.partitioner.class";

    private static final transient String OUTPUT_PARTITIONER_CONFIG = "cassandra.output.partitioner.class";

    private static final transient String INPUT_KEYSPACE_CONFIG = "cassandra.input.keyspace";

    private static final transient String OUTPUT_KEYSPACE_CONFIG = "cassandra.output.keyspace";

    private static final transient String INPUT_KEYSPACE_USERNAME_CONFIG = "cassandra.input.keyspace.username";

    private static final transient String INPUT_KEYSPACE_PASSWD_CONFIG = "cassandra.input.keyspace.passwd";

    private static final transient String OUTPUT_KEYSPACE_USERNAME_CONFIG = "cassandra.output.keyspace.username";

    private static final transient String OUTPUT_KEYSPACE_PASSWD_CONFIG = "cassandra.output.keyspace.passwd";

    private static final transient String INPUT_COLUMNFAMILY_CONFIG = "cassandra.input.columnfamily";

    // this must == OutputFormat.BASE_OUTPUT_NAME
    private static final transient String OUTPUT_COLUMNFAMILY_CONFIG = "mapreduce.output.basename";

    private static final transient String INPUT_PREDICATE_CONFIG = "cassandra.input.predicate";

    private static final transient String INPUT_KEYRANGE_CONFIG = "cassandra.input.keyRange";

    private static final transient String INPUT_SPLIT_SIZE_CONFIG = "cassandra.input.split.size";

    private static final transient String INPUT_SPLIT_SIZE_IN_MB_CONFIG = "cassandra.input.split.size_mb";

    private static final transient String INPUT_WIDEROWS_CONFIG = "cassandra.input.widerows";

    private static final transient int DEFAULT_SPLIT_SIZE = 64 * 1024;

    private static final transient String RANGE_BATCH_SIZE_CONFIG = "cassandra.range.batch.size";

    private static final transient int DEFAULT_RANGE_BATCH_SIZE = 4096;

    private static final transient String INPUT_INITIAL_ADDRESS = "cassandra.input.address";

    private static final transient String OUTPUT_INITIAL_ADDRESS = "cassandra.output.address";

    private static final transient String OUTPUT_INITIAL_PORT = "cassandra.output.port";

    private static final transient String READ_CONSISTENCY_LEVEL = "cassandra.consistencylevel.read";

    private static final transient String WRITE_CONSISTENCY_LEVEL = "cassandra.consistencylevel.write";

    private static final transient String OUTPUT_COMPRESSION_CLASS = "cassandra.output.compression.class";

    private static final transient String OUTPUT_COMPRESSION_CHUNK_LENGTH = "cassandra.output.compression.length";

    private static final transient String OUTPUT_LOCAL_DC_ONLY = "cassandra.output.local.dc.only";

    private static final transient String DEFAULT_CASSANDRA_NATIVE_PORT = "7000";

    private static final transient Logger logger = LoggerFactory.getLogger(ConfigHelper.class);
